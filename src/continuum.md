...
What exactly is mass ? The answer is in "Thermodynamics".We know, to move from a "disorderly state" to a "state of order" - what is normally referred to as decrease in entropy of the system, the energy of the system increases. This energy is held in the system as potential energy . Scientifically , it is hard to build a direct relation between entropy and mass but it is not hard at all to perceive. For example if you drop a spoon of salt in a glass of water, the salt mixes with water. We say that the entropy of this glass of water has increased. We also say the natural tendency of a system is to get to higher entropy or higher disorder. And we also attach this tendency of moving towards higher disorder with unidirectional arrow of time. But this is only half the story. To get to a lower state of disorder or to manifest is as big an inherent impulse. Proof is in the pudding. We observe so much mass around us - in planets , stars and black holes. The universe appears very orderly. Why ? I think we need to think of Entropy in a different vantage - the ability to pack the information in the smallest possible volume. 

Just like unattended systems have a fundamental property to move towards disorder, the attended systems have a tendency to move towards order. Everything in our universe wants to express itself. This quest for expression is the fundamental drive. The question however is how do we determine what is more orderly? There must be an information system that keeps a track of the disorder and also a decision system to choose order over disorder. 
