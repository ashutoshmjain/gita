...
`Maharishi` taught her `Sanskrit`. She quickly picked up the difficult language. `Maharishi` chanted `Mantras` to her. It became a daily ritual. `Maharishi` was obviously an expert teacher of `Akshar Gyaan`, thanks to the methods he learnt from his grandfather. Reciting and scribing, went 'hand in hand' . And he used palm leaves for scribing. The island was the only place in and around `Mathura` with Palm trees. Maharishi would stack a dozen large leaves in fire pit before going to sleep - such that they were smoked inside out - gradually, as the pit cooled overnight. They used smoked leaves to scribe the `Bramhi` alphabet —  first `Maharishi` wrote, and then `Matsya` copied the alphabet to simple words. Slowly she started scribing sentences and got at ease in conversing. She realized the language was natively designed to speak poetry - on the go! `Maharishi` said scribing was an ability that opened a portal to the continuum - of time and space! She didn't understand the idea but she believed.

There was subtle, but planned experimentation. `Matsya` noticed, `Maharishi` gradually increased the smoking duration, temperature and distance from the fire - to get the best possible texture in palm leaves — and flexibility like a cloth. And that he was refining the ink as well. At times he applied a thin coating of different muds on palm leaves. As for ink, starting with simple Henna paste, he had mixed number of soils and heated the mixture to get a permanent impression. Now she understood why `Maharishi` was carrying the Palm leaf with him when he returned from the island - in their first meeting.

It was probably a daily mud bath followed by a fresh water swim in `Yamuna` that made her beautiful, or the Sandal wood lotion that `Maharishi` himself prepared for her; or a vegetarian diet of milk and fruits, or the growth of internal knowledge. But she assumed it were the blessings of `Maharishi`! And who knows?
...
She gazed and understood the motion of stars. And she understood the effect of lunar phases - on waves of `Yamuna`. She knew it was `Yamuna's` holy water that blessed her with a divine son, but she wondered if `Maharishi` ever embraced her! Ever made love to her like a man would do to his wife. She wanted to know, but she was too shy to ask. And she wouldn't change an iota of this relationship, for it felt divine. Even if she was a surrogate, the experience was well worth the time - and all her possessions. But she didn't know the darkness of that night got carried to her womb. The boy would be dark of complexion, and one seeking to know it all. And thus the name `Krishna` that meant born out of darkness - darkness being the true observer. His spirit captured all the stars of that night. He would see depths of the space that no one in the sun-lit day could ever. He would see beyond the motion of “Time” and bind it to the words. Words that would flow like `Yamuna` to carry all other opinions along with. And just like `Yamuna` they would span the heights of `Himalayas` to the depths of the ocean.

## 9.2

Time moved fast. Her breasts swelled up as motherhood took over her. She wanted to be close to `Maharishi`, but he knew better. He knew the joy was transient. Enormous pain was waiting for `Matsya` when she must let a part of her own body go — the curse of motherhood. If you create something complete, you must let it go - to prove the "completeness". But her curse was bigger of all mothers. She must leave him. For a mother, the biggest pleasure is to see her creation grow. `Matsya` must let go the warmth of vicinity - she must break the biggest bond.
