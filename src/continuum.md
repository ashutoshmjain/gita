...
I don' think you will be surprised if I said we all are living at the edge of the time. And "all" includes everything - big or small. The stars , galaxies and of course the chair that you are sitting on. None of us can jump ahead in time even by a tiny bit. Why ? Because edge of "time" is NOT a spatial edge. There is no place to jump to. It simply unfolds on us. I can prove it to you scientifically that all of us are moving with time  and none of us may take the liberty to move beyond this speed limit - the speed of light -  but that will be an awful waste of words cuz we know it from our concrete experience . This is one area where our experience and science are of the same opinion ! Now this is not to say that we must move at the speed of light in time. Science shows as our motion in time reduces when we move fast in our space. Essentially the vector sum of our spatial movement and that in time is constant - the limiting speed. If you see the graphic below - the circle represents our cosmos. On the horizontal axis are the photons that travel at the speed of light in space. Thus time stands still for them. The circle assumes a isomorphic and flat universe (of special relativity). Manifested mass changes the curvature a little bit. It becomes a distorted circle. 

![circleOfLight]()

Most of our manifested objects have very low spatial velocity - order of magnitude less than light. This the manifested world moves at the speed of light in Time whereas the Electro Magnetic waves becomes the stable background that has no motion in time. 

Nor can we go back in time.  Why ? Now this is a profound idea. Technically , travelling back in time should be possible because quantum Mechanics deems "Time" directionless - Means you can move back in time as long as you respect the speed limits. But if you noticed from our conversation on the "Quest" in the first part of this post, our quest is unidirectional. Because we don't want to search the signals that we already did. Thus the entire set up is for the waves of future to come to our senses .This apparatus has developed over billions of years. We are simply a future seeking species. The nature of our Quest makes the "time" unidirectional. And hence we can't jump back in time. 
