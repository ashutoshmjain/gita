...
Modern interpretations are based on superficial argument that the name "Advita" means "Not Two" (non dual) contrasting the hallmark duality of Samkhya. They miss the point that Adviata's mission was to help society get over a convoluted belief system of hundreds of deities and demigods, often resisting each other at the expense of social mobility. Thus the message of non duality was a necessary method to bring the society together.

Advita, in truth, didn't refute the duality of Samkhya. Quite the opposite, it reinforced the indivisibility of Purusa  as one singular form of consciousness - often termed "Nirguna Brahman". In essence, it  expanded the scope of Purusa from individual droplets of consciouness to an immense universal field. This single field acts as the basis that supports all the "mind and matter" complex (manifest Prakriti). Advaita did add a philosphical underpinning that the nature of the manifested is transient (time dependent), and hence it is unreal (Mithya) - one that decays. It was the first attempt to name the manifest as Matrix (Maya) because it acts as a jail to an untrained mind. Pure consciousness as Brahman is thus the only truth in Advaita's vantage.
