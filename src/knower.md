...
Conventional definitions are fudgy and overlapping.  "Information" is seen as trivial inputs, for example : "It is 27 degrees this afternoon.", or "the S&P 500 was at 6031 this morning!". And "knowledge" as something profound - grounded in logic or science - for example "speed of light is a constant". A better (and maybe poetic) distinction is:  "information" is "noise whereas "knowledge" is the "signal". Looking at few samples of information -it is extremely hard to ascertain if we are getting closer to the knowledge or drifting away . Even if we had large set of readings, it is still hard to say conclusively if the path itself was right! You need data at a universal scale, and  a sophisticated apprach to synthesize massive data sets. There needs to be a way to discriminate decicively against a wrong path to choose the right one. This allows us to ignore all the information associated with the wrong path. This ability must work efficiently whenever the path splits into two - ie every bianry decision. This method, in modern AI parlance, is called Value awareness and in Vedic science it is called - Viveka. The modus operendi of Viveka is Karmyoga and in AI parlance, it is called "Value Function".
