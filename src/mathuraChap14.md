The flight back home was quiet. The Friend felt she was finally discovered by the bigger league. The Mentor was sure more than his humble looks. She felt rich - with one full coin in her wallet and an unsaid contract to work for at least next six months. At least that is what she thought. Most other creative projects were barely week long. They paid her bills but she had to keep an eye on her balance for the work demanded being in the city. And a flying car was the only way to commute in over crowded San Francisco. If you dared to walk you were sure to step over a homeless person. Despite all the AI dollars, the homelessness was still rampant - no one could figure out a solution. So much so that they started saying that spirit of SF was in the litters on the street. Being a back-end guy, the Boyfriend could stay in the suburbs. And walk his two dogs.

Boyfriend loved his work. He was passionate about the technology - a borderline geek. He was mixed well with Angel and Fairy and that is what was most important to the Friend. This was the only circle where she could be herself. He made conscious effort to be part of this group - except for one small issue - he was not fully aligned to Fairy's idea of activism. He was fine with most the issues she worked on - for example advocacy to get fair credit to humans. [^fairCredit]. But she was not gentle to the idea of burning 90 % of compute on the transaction layers. Boyfriend, on the other side believed that climate threat was a hoax[^hoax]. He made sure he never broached this topic in Friday meet ups but off late, Fairy was getting more vocal about her convictions. That left little room to breathe in friend circle because the social media was anyway all about energy conservation. The media cared less if the compute was being invested on AI or on open infrastructure - the general vibe was consume less among Angels and Wizards. Whereas humans wanted more and more of free stuff.

It wasn't that he didn't try to put the nuances in layman terms, but Fairy always turned a dumb face. You can't engage disinterested. For example she laughed off to the idea that Bitcoin was not competing with any sovereign currency. It was simply a data layer below the currencies - to record proof of work. Because a currency must be substantiated with the amount of work it's unit can get done - that is the only way to remove a commodity backfill. Currencies only need to provide liquidity among different players before they settle on the bitcoin data layer. Lightening - a data layer of liquidity instituted as a protocol the first native bitcoin currency - a Satoshi. But no one stopped any sovereign currency to provide similar liquidity. It was a different thing that most sovereign currencies just couldn't compete with Satoshi because it was fast, lowest fees and could enable micro-payments. Nostr is a general data layer for all sorts of other applications. It was easy for people to recognize the separation of applications from the operating systems but data was always considered part of the application. Every legacy application used to have it's own data model and some sort of database to suit the purpose. They all followed their own rules. Bitcoin, Lightning and Nostr standardised those rules and turned them into a "protocol" [^protocol]. With these underlying protocols, wizards[^wizards] had democratized the data [^data]. 

The standardised data layer(s) also meant a friction for the applications (mostly AI applications). For an investor, they must have greater return on investments than simply investing in the data layer(s). Which interalia meant, more efficient applications.  With better returns on their applications investors kept buying into BTC that led to higher BTC price and hence better return on the compute invested in data layer - a virtuous cycle. He thought Angel understood the concept but he was not sure. 

Angel was not sure where this narrative was going. What does Mentor really want to communicate. He was now fully convinced that the fire incident was off the radar. But now his worry shifted to how this new project is taking shape. Are we all going to work actively on it. How much time would if have on him for his plate was full in Biotech. The bees project was already in his past. His next endeavor was already looking good but it was even darker. He was asked to join the Sleep Project as an industry representative. Sleep interface was widely used by humans to let their brain be used by compute intensive AI application - such as air traffic control. But the new usage patterns were even more demanding. Angel was being asked to look at the unintended consequences - thanks to his experience with the honey project. He was among the first to identify this loophole in bio designs - and got his voice heard - thanks to association with the Mentor. He clearly saw that Mentor was happy this evening. He felt he could add something of value in Fairy's eyes. And he was glad that Fairy and her Friend were now plugged in with his spiritual leader.

Fairy was busy reading the next post. She was keen on what went on between `Shantanu` and `Matsya` on his return to the boat. She wanted to live those human emotions - so difficult to relate to her race.
...
- As the acceptance of protocol increases, it gets exponentially harder to change it because you need 100% acceptance. Thus no one can change TCP/IP. It's improvements must be communicated well in advance and feedback must be taken from all the stakeholders. This however doesn't mean new protocols can't be instituted. For example TCP/IP is a computer communication protocol but Bitcoin is a protocol to transfer the value. Lightning is a protocol to provide liquidity. And Nostr is a protocol to separate data layer from applications with massive users such as social networks, dns, ride sharing, messaging, publications, news networks, banking. The key aspects of Nostr is enabling the users to carry their data with them to different applications. Bitcoin, Lightning and Nostr have similarities in their design elements but most importantly they are distributed databases with global rules - they are protocols for data management.
