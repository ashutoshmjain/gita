...
The definitive thing about our sensory perception is we always want to know about that split second. What happened just before the start ? And what is going to happen after the end. And it is quite logical. Let us say we are looking for a needle in a 'proverbial' haystack. The most logical way is to split the stack into two equal pars and search the first half. If we found the needle, we don't need to search the rest. Else look for the needle in the second half. Thus looking outside our observation space is a part of our sensory algorithm.
...
Now that we have a good handle our unidirectional arrow of time - our sensory reality,  the question is what is underlying reality - our second conjecture ? To make it easy to comprehend , we need to review our observation space once again ..
