...
It wasn't that he tried to explain the nuances in layman terms but Fairy was not willing to listen to his idea. For example she laughed off to the idea that Bitcoin was not competing with any sovereign currency. It was simply a data layer below the currencies. So was lightening - a data layer of liquidity below financial applications and a general data layer for all sorts of other applications. It was easy for people to recognize the separation of applications from the operating systems but data was always considered part of the application. Every legacy application had it's data model and some sort of database to suit the purpose. With these underlying protocols, wizards[^wizards] had democratized the data [^data]. It also meant a friction for the applications, they must have greater return on investments than simply investing in compute to organize the data layer. Which interalia meant, more efficient applications with better returns kept improving the btc price and hence better return on the compute invested in data layer - a virtuous cycle. He thought Angel understood the concept but he was not sure. 
