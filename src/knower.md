...
This is where Quantum Mechanics provides a crucial insight. It is common knowledge that an act of measurement collapses the wave function. "Wave function" is just a fancy way to say "all possibilies" of a quantum system. Quantumness of a system means all the possibilities exist together and an observation breaks this "possibility cloud" into a unique state. It is like the Monday morning when you wake up thinking it is still Sunday. Weekend quantum system wouldnt collapse till Alexa announces it is 8 am on a beautiful Monday, and then it all suddenly becomes real:-)

In Samkhya, quantum state is represented by prakriti. Prakriti, an equilibrium of potential, manifests one step at a time through the proximity of Purusha, an eternal but random observer. This observer, in both QM or Sāṃkhya, need NOT be "conscious"—it is just an act of measurement. Just the way Alexa, though not conscious, measured your Monday morning!

> While the concept of Prakriti is well understood in modern science —all elementary particles exhibit quantumness - the idea of an elementary observer is rather mysterious. Why should Purusha seek to observe? What makes it take random measurements?
>
...
>
> *   ***Tamas*** represents all possibilities. This is a state of zero self-awareness, sometimes described as inertia or darkness because it is a state of perfect, undifferentiated chaos. This state is also called "action-less" pure prakriti without any motive. It would be easier to imagine Tamas as multitude of dualities superimposed over each other rather than unique independent possibilities - as if each possibility always comes with a mirror image - one that it is - and the other the way it appears to Purusa - truth and appearance of truth. 
>
> *   ***Rajas*** represents the motivation to discriminate, choosing ONE duality from the chaos of thousands of dualities of Tamas. It is the state of doubt or internal struggle because it is always stuck in dualities. Finally, if it succeeds, **Rajas picks up one duality and offers a choice to the observer**.
>
