...
This transition of wave to particle and vice versa is enabled by something called electro-magnetic field. We will talk a lot about EM fields and EM waves when we discuss "consciousness" as EM waves enable one of our most important sensory capability - our sense of vision. The point that I want to make here is about the beauty of our design  - and that point is - the EM fields are generated by the manifested objects. In a way manifestation is what cause the information.  Think about it for a moment before we get into more details of manifestation - mass. 
