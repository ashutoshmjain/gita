...
- **Potency of expanse** - a vast network of manifested entities known as `Bramh` exists in perpetuity, to let them interact with each other - to express different attributes of knowledge enabled by their form and state. The goal of the collective is to decrypt the inexpressible knowledge - from the information held with in relationships of individual entities. 
