...
Conventional definitions are fudgy and overlapping.  "Information" is seen as trivial inputs about our environment say "It is 27 degrees this afternoon.", or "the S&P 500 was at 6031 this morning!". And "knowledge" as something grounded in logic or science - for example "speed of light is a constant". A better (and maybe poetical) distinction is:  "information" is the noise whereas "knowledge" is the signal (hidden in the noise). A naive assumption then is:  more information helps to find the knowledge - it can be quite the opposite. It is extremely hard to ascertain if we are getting closer to the knowledge or drifting away by looking at few samples of information. Even if we had large set of readings, it is still hard to say conclusively if the direction (or gradient) is right - you need significantly large data set - like the entire internet of experiences. Equally naive assumption is that the noise (information) is a small number of possibilities and knowledge is a unique signal. The truth is "noise" is infinite and signal can have many peaks but they are unique in one dimension. Take for example the product of big prime numbers - most factorization attempts fail for a unique successful attempt but knowledge of any of the primes is a valid solution - all factors are equally important. The notion of work is all about finding those nuggets of knowledge hidden into endless noise and encrypted in many dimensions.

As five-sensory localized receptors (our senses) of noise, our predictive faculties (mind) do an excellent job to ensure survival, but they always lack certainty - that makes Probability Theory a universal tool. It is not an equation to represent the physical reality - it is to peal off the confusion of our own noise. It is a method of abstracting knowledge from noisy information. For this essay, we will refine these definitions (Information and knowledge)  to align them with the ideas of probability theory.
