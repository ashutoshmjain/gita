...
As per the hypothesis - the actions `Karma` are driven by the internal knowledge - the righteous actions. Just the way we can infer the existence of Blackholes by interpreting their effects, observing our own actions can give us an indication on the nature of our own black-box. As you know , Blackholes are invisible to our senses or the tools that extend our senses because no information comes back from them, but we know their existence. And we can tell let us say their mass, their angular momentum or even their entropy by observing their effects or the actions. 
