...
> The modern point of view about these two ancient schools of vedic science is misguided - and that includes the AI chaybots. The AI synthesis is : Samkhya was atheistic vs the blind devotion of Advaita in singular God - much like the science vs religion debate of today. This line of thinking, however, lacks evidence. It is based on our current divisive experience. We are simply juxtaposing on past our own reality of divergence of science from faith. Modern interpretations are based on symentic argument that the name "Advaita" means "Not Two" (non dual) contrasting the hallmark duality of Samkhya. They miss the point that Adviata's mission was to help society get over a rigid belief system of hundreds of deities and demigods, often hindering social mobility. The society was locked in water tight compartments of cast and creed. The message of non duality was necessary to bring the society together.

Advaita didn't refute the duality of Samkhya. Quite the opposite, it reinforced the indivisibility of Purusa  as one singular form of consciousness - often termed "Nirguna Brahman". In Samkhya, Prakriti is described to have three fundamental qualities - Sattva, Rajsa and Tamsa. These are called gunas - tiny threads ( as in strings of string theory). A Purusa that is not mixed up in three gunas is called Nirguna Brahman in Adviata. On the other side, the one that is trapped in Prakriti is called Saguna Brahman. In essence, Advaita  expanded the scope of Purusa from individual droplets of consciouness to an immense universal field. This single field acts as the basis that supports all the "mind and matter" complex (manifest Prakriti). Advaita did add a philosphical underpinning that the nature of the manifested is transient (time decay), and hence it is unreal (Mithya). To it's symentic success, it was the first attempt to name the manifest as Matrix (Maya). For Maya acts as a jail to an untrained mind. Pure consciousness as Brahman is thus the only truth in Advaita's vantage. Just like Samkhya, Advita agrees that mind is a construct of Prakriti. It, however, posits that the point of mind is to set up plumbing to enfree Purusa from traps of Maya - awakening.
...
Conventional definitions often see "information" as a tip to predict next event (say a stock market crash, perfect weather for the beach etc.); and "knowledge" as the concrete universal reality (speed of light is a constant). For this essay, we will flip these definitions to align them with the probabilistic quantum world. Probablity is a useful tool. As pure observers, our predictive faculties lack certainty. That is exactly where probabilty shines - to handle uncertainty.
