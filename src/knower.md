...
A good question to ask is why knowledge is better than information - why signal is better than noise? Right off the bat, knowledge represents tremendous compression over information. For example - the storage space required to hold the record of one million events is a million time larger than storing the idea that Heads and Tails are equally likely. The important thing is "knowledge" is not lossy - it must carry the same level of fidelity. Quite the opposite, information is always lossy. Looking merely at the quantitative aspect - the simple probablistic definition that heads and tails are equallly likely - is not limited to only a million flips - it represents a trillion trials of a say a million flips each, with same cognitive accuracy. Such knowledge is represented as `Atman` in both Sanmkhya and Advaita. The key insight of this understanding is that the knowledge is most compressed form of a signal that can replicate itself infinite times - over and over again. Which means knowledge is a force of decentralization. 

> One who fully understands this most compressed signal is called knower. Since everyone and everything is a a replication of this primordial signal, it means knowledge a full copy of knowledge exists in every single being - everyone can realize the knower with in. 
