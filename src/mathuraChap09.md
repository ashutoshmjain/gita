...
He continued after making sure of the heightened curiosity of both his listeners - The thing that is locked-in is complete in itself - the way a seed has all the knowledge to grow into a vast tree. The properties of this hidden thing are such that if we add up all the separations - infinitely many and infinitely large they may be - they all sum up to zero. And if we multiply all the separations - they all together produce the unit - one.
