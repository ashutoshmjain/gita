...
A wave has two primary aspects - time , normally plotted on the x axis and an amplitude plotted perpendicular to the linear time. If we take the time aspect out of the wave, a wave is nothing but a spinning circle. The idea of removing the linear time from x axis is not uncommon. Such plots are called "circular graphs", sometimes also referred to as unit circle. The spin of the circle defines the frequency of the wave and the size of the circle defines it's amplitude. In Trigonometry, the spin functions can be described by Sine and Cosine of the angle at the center of circle with respect to to the x axis or the perpendicular to the x axis. If we prove that "time" is a creation of our sensory perception, than it is obvious that underlying reality is circular. 

![](./circleOfKnowledge.jpeg)

For a better visualization, [check this out](https://jackschaedler.github.io/circles-sines-signals/sincos.html). One may argue that even circle has some element of time in terms of it's diameter on the x axis. And that is correct. If we remove the diameter too, then we have a unidimensional oscillating point . It must be at least a Planck length to support the nature of our perceptible universe and is also known as a "string". This might encourage you to delve into mathematics of string theory :-) ; as it did to me. Here are my two cents - the math is insanely complex, at least beyond my comprehension ! and we don't really need it because existence of strings is quite obvious from above discussion. One good take away from this exercise however is, the realization that there is no notion of "direction" of time in math. And that, mathematics is a lot better tool to express our reality than our sensory perception if only we have ability to understand the nuances. Our sensory perception is a great tradeoff becuase we can realize the same knowledge (the one that math describes) through "actions-orientation". Krishna says - "action orientation" - `Karm Yoga`  is lot easier than trying to decipher the truth mathematically - `Nyaan Yoga`.


If we think the oscillating strings as the basis of our reality, the question that we should rather focus on,  is how do we turn these dot like strings into a spinning circle of knowledge that leads to waves of information. Knowledge , together with waves of information is what we know as manifestation. It might become obvious at the end of this article, that `Karm Yoga` - actions orientation - is the mechanism to decrypt the knowledge in a fashion that turns into a spinning knowledge of circle. 

Let us assume we are at the center of the circle and we want to observe the circumference in a clock or anticlockwise fashion. What we observe is a wave. This is because our senses focus only at one point at an instance. Thus our focus moves along the circumference. This focal line is also referred to as "Phaser" in the study of signal processing. This is the point where the energy (or disturbance) is situated. The notion of disturbance is in what we want to sample or  measure or observe. We can also say that the energy (disturbance) exists because we are observng that specific point on the wave given  every direction is valid in math - ie effect can lead to cause .. but I guess I am getting ahead of myself.. Let us bring our focus back.

As I said above, a wave is an information pattern of  of circular "spin" of a piece of decrypted knowledge. This could be something tangible such as a tree or intangible as the software project you are working on. When enough knowledge is decrypted, it becomes a spinning entity that could be perceived by others. The quality of manifestation depends on the quantity of knowledge decrypted. For example a tree is self evident but your software project still needs ton of explanation and assumptions. When your software unlocks enough knowledge, it might turn into something as self evident as "internet" or an "iPhone". Consumers will never understand the amount of work that went into it for the "knowledge" itself is beyond their perception, but they shall swear by the manifestation. They will flock around it because they are now able to perceive it with their sensory apparatus.  It is not hard to imagine that if we have a spinning spiral, the wave amplitude will grow bigger as the spiral gets bigger and likewise it will get smaller as the spiral contracts. The question is how do we perceive these manifestations with our sensory apparatus. Before we do that, we need a bit of a refresher on our "sensory apparatus". 
