...
Conventional definitions are fudgy.  "Information" is seen as run of the mill inputs about our environment say "how is the weather tonight?", or "how well the stock market doing!". And "knowledge" as the concrete universal reality - speed of light is a constant. For this essay, we will refine these definitions to align them with the probabilistic quantum world. As five-sensory localized observers, our predictive faculties lack certainty - that makes probability a universal tool to understand reality - though abstract and counter-intuitive.
