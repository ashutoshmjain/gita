...
The idea that Rajas selects only one dulaity out of infinite possibilities of Prakriti indicates that there is an overarching code that drives the option picking. The knowledge held opposed to the manifest state is just a tiny fraction. The overarching knowledge is a cumulation of all past events. It sums up to probabilities with in a prakriti purusa play.
