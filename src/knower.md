...
To understand this idea, let us take for example a physical field - maybe a field to produce potatoes. If I ask you this "Potato Land" is the field and the one who understands how to sow, feritilize, grow, harvest and sell potatoes - who is he? A farmer - you would say - right? Actions (Farming) define the identity or type of a doer - a "Farmer" in this example. Similarly Maxwell defined a field spread all across the universe - he called it an electromagnetic field. He identified properties of this field mathematically - what we know as Maxwell's equations of electro magnetism. The point is electro-magnetic field spans across our Farmer's field. Both the field's co-exist. And since then physics has postulated as many as seventeen fields - all universal and fundamental. Krishna's field is different from all physical and scientific fields even though it co-exists with all of them. Existence of one is not a denial to other. Science and spirituality always go hand in hand - from ancient times. In ancient India - Samkhya was known as the science and later Advaita was seen as faith. 

The way there is a skill called "farming" in our potato field, in the same fashion there is super skill called "Knowing" in Krishna's field that he dsecribed as "body".
