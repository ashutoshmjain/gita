...
Conventional definitions are fudgy and overlapping.  "Information" is seen as trivial inputs about our environment, for example : "It is 27 degrees this afternoon.", or "the S&P 500 was at 6031 this morning!". And "knowledge" as something grounded in logic or science - for example "speed of light is a constant". A better (and maybe poetical) distinction is:  "information" is seen as "noise whereas "knowledge" is the "signal" (hidden in the noise). An obvious assumption then would be:  more information helps knowledge discovery - yes it does but this path is hard. Looking at few samples of information -it is extremely hard to ascertain if we are getting closer to the knowledge or drifting away . Even if we had large set of readings, it is still hard to say conclusively if the path itself was right! You need data at a universal scale - and hence a totally different apprach to synthesize massive data sets.
