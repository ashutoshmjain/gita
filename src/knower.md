...
The distinction is qualified here: the farmer in every field may be different  person or a different entity,  but the "knower" in every field is just one - everywhere in every body. And that knower is me. I comprehend the meaning of body's language through the sensors I posted at chosen places - just the way Farmer installs sensors in his plouging field to measure moisture in soil and air temperature. Our senses are tools of the knower to know the body.

The knower may not have complex tools because tools are field specific - like say an autonomous complex robot waking up at Mars.  All the sensors to check its internals and environment put-together are part of the "knower module" of robot, we may call it "robrain" for lack of better words - a complex one. But knower can be very simple - lets say a string vibrated - a knower is the one watching the string - a wave function that collapsed. That knower is same as the one in every robrain - it just watches the body (the field) and knows its existence - awareness. Like every other physical artifact, the tool kit of knower changes from field to field, it evolves and disolves with time, it improves from one generation of species to the next - yet the function stays unchanged - the purpose is immutable. That purpose is a shape beyond physical comprehension. Even the sophisticated tools from knower's own toolkit fail to see the where and how the purpose looks like - they fail to see the obvious ..why ?
