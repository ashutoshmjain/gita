...
Conventional definitions are fudgy and overlapping.  "Information" is seen as general inputs about our environment say "how is the weather tonight?", or "how well the stock market doing!". And "knowledge" as something  more grounded in science or say math - speed of light is a constant. For this essay, we will refine these definitions to align them with the probabilistic quantum world. As five-sensory localized observers, our predictive faculties lack certainty - that makes probability a universal tool to understand reality - though abstract and counter-intuitive.
...
*   **Knowledge** is the awareness of all options and their respective probabilities. For example, the simple idea that a fair coin *may* land on either heads or tails with a ~ 50/50 probability is *knowledge*. Right off the bat, knowledge represents tremendous compression over information. For example - the space required to hold the recod of one million events is a million time larger than storing the idea that Heads and Tails are equally likely, even though it needs opening of a new cognitive dimension. The important thing is "knowledge" is not lossy - it must carry the same level of fidelity. Quite the opposite, information is always lossy. In a pefect world, there will always be fifty fifty heads and tails - not say 499000 Heads and 501000 Tails in a successive million flips of a coin. In Samkhya, this is called "Vikara" - the aberrations of physical world that leads to the normal distrubtion rather than a full expression of knowledge. Looking merely at the quantitative aspect - the simple probability rule for coin flip is not limited to a million flips - it represents a trillion and a quadrillion flips with same cognitive accuracy. 
