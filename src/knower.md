...
The Sāṃkhya school of thought considers a perpetual duality of Prakriti and Purusha—the potential and the observer- in contrast to Advaita's non-dual brahman (God) as the only truth. The modern view is: Samkhya was atheistic vs devotion of Advita in singular God - much like the science vs religion debate of today. This apprach is lacking any evidence and based on our current divisive experience - we are simply juxtaposing our own experience on the past. Adviata's main purpose was to help the society get over a system of diverse deities and gods. Modern interpretations see it as an opposition to Samkhya simply because the name "Advita" means "Not Two" (non dual) contrasting the duality of Samkhya. Advita, in truth doesnt refute the duality of Samkhya, it only reinforced the indivisibility of Purusa (often termed as Nirguna Brahman) as one singular consciousness. In essence it expands the scope of Samkya from individual droplets of consciouness to a field of consciousness on which all matter takes shape. It adds a philosphical layer that the natire of manifested Prakriti is transient and hence it is unreal (Mithya), also named Maya (Matrix).

Let us understand the core concepts with Sāṃkhya because this path is easier for the scientifically-predisposed mind, and it satisfies the question that haunts both science and religion: "What was there before the universe began - before bigbang?". In other words, Sāṃkhya is designed for logical closure. It is an analytical view of Vedic science. The word "Suṃkhya" in Sanskrit literally means "a number." Sāṃkhya thus means: based in rational logic.
...
Knowledge means you build the system inside out, not outside in. While a well "informed" may cite event(s), knowledge is the means to hypothesis. It can predict things or lay down prophecies. Knower is an insider. It is so deeply entrenched that it is invisible even to ardent observers. An observer is collecting information (past), a knower is choosing the direction of future by designating what to observe. 
