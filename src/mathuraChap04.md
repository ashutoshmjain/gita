Before the "new" replace the "old", many possibilities of the "new" must converge to offer one unified path forward. Compromises must happen. Common denominators must be established before the  new rules of engagement come into play. In essence the "new" must represent "Truth". But rules alone are not enough. They must be driven by the common good and most importantly, they must be well communicated to all the stakeholders. It takes time to understand, conceive, communicate the path, and to get all the impacted on the same page. A global change is a slow and arduous till it gets to the critical mass. Once it gets to the critical state, the change gets fast, and  irreversible.

On the other side, the "old" that was once the "truth" stagnates. It doesn't keep up with the continuously changing (wave) nature of our reality. It perishes because many forks try to patch the truth. Inter-rivalry becomes the norm. More factions lead to more fragmentation. The change from "old" to "new" is thus keeping up with the truth [^truth]. 

This path of truth, a vigil appreciation and adapting to the "change", is righteous, called `Dharma`, as opposed to popular belief that `Dharma` is a translation for English word "religion". `Dharma` is simply rendering one's duties without desires. Desire, by definition is an expectation to alter the current reality for personal gains. Thus desire driven actions can never reflect the truth. Religion, on the other hand, most of the times, is fixated either to the "old" or painful persuasion of the "new" towards a desired outcome.

Finding a righteous path is, however, easier said that done. The definitions get nuanced as soon as we peal the first layer. Simply because every human sees the reality differently. Even the meaning of words are perceived differently and above all, humans have a natural tendency to justify their actions as righteous. The biggest question thus is "what is the righteous path" and the answer may always stay elusive till we determine " who we are?"

# Dharma

The all important question — if (or not), there exists one unique righteous path? — what is the true definition of `Dharma` - was a matter of regular discussion that ran deep in the family. `Vaśiṣṭha`, opined there were many right paths for humans to realize their potential. He truly beleived in power to the people. He felt a farmer was as important as a priest and so was a cobbler. As a pragmatist, `Vaśiṣṭha` wished peace to everyone no matter what path they chose. One of the reason `Vaśiṣṭha` was so much influential among the seven `Bramhrishies` was his unique blend of knowledge and humility. However, his son `Śakti Muni` argued that even if there were many legit paths, one person, must stick to one path in one life-time. If someone kept changing his course based on changing situations, how s/he is any different from animals? And how would s/he accomplish excellence? 

This was the definition of `Karm Yoga` as per `Sakti Muni` - fully committed to one chosen path. `Karm Yoga` as an idea, was different from the `Nyaan` and `Naad Yoga` in that the purpose was to indulge in `Karma` - actions. The knowledge gained due to repetitive actions was a mere by-product - quite the opposite of the approach of `Nyaan Yoga` wherein the goal was to accomplish a desired goal with least actions - find the easiest way to agriculture, transport or metal works for example. `Karmyoga` didn't seek ascetic behaviour as expected from `Naad Yogies`. In that sense, it was easy to practice for masses. All one needed to do under this ideology was to perfect one specific skill and keep on doing it - just like a machine. In a way, `Sakti's Karmayoga` was the beginning of the of "specialization". 

## 4.1
---

`Śakti Muni` practiced what he preached, and he ended up giving his life for the sake of his beliefs. That fateful morning, `Śakti Muni` was en-route to the river with rest of the congregation — for the morning dip in `Yamuna` — a daily routine,`Vaśiṣṭha` had cultivated in his group. `Bramhrishi` didn't join that morning as he was under weather - winter mornings were taking a toll on the aging saint. `Śakti Muni's` wife too excused herself due to early pregnancy sickness. 
...
In the morning rush hour, `Śakti Muni` expected `Kalmashapada` to clear the way for the scripture mandated right of path to a sage, and demanded a sage never gave up his course. On the other side, the king, oblivious to `Śakti Muni's` metaphorical extension of the ideology, expected a clear path for himself and particularly his new beautiful queen. He had expected the sage would shower blessings on this new union. In fact, last night, he had hoped `Śakti Muni` would show up at his picnic place to welcome him on this side of `Yamuna`. 
...
The conundrum is nothing new. For example, when we see a computer, we all know for sure the existence of programming languages. But just knowing the existence of "programmability" doesn't mean knowledge of programming. We must do certain actions to learn coding. The necessity to "act" was there in every endeavor — be it mining or agriculture. `Maharishi` was intrigued with this power of actions. What is so potent in "actions" that leads to cultivation of knowledge? — he wondered. Building on his father's ideas, he named this potency of actions' `Karm Yoga` though the underlying science of actions (`Karma`) was still a puzzle. It had take couple more generations and an incarnation of God himself (as `Krsna`) to fully explain the science of `Karma`.

While young `Parāśara` had nothing going right for him, there was one silver lining. His mother `Adrushyanti` was a kind grace to keep his life together. An `Aacharya` herself, she was probably the only one who knew what `Sakti Muni` had on his mind. She made sure the child got his father's ideology without any aberrations.  She explained to `Parāśara` how his father envisioned to true up the goals of his grand father. The idea was simple, yet powerful. First - the only way to get over the growing mistrust between `Naad` and `Nyaan Yoga` was to reunify both these streams into something new. That new unified stream was `Karm Yoga`. The the outside world, `Sakti` presented as is he knew the path but internally he was not inflexible. He was still solidifying his own ideas and he hoped that once more people subscribe to his ideas the right path would automatically emerge.

And second - the way `Sakti Muni` approached it was to find the common denominator. He thought the fundamental driver of both the `Yogas` was life-long dedication to "one" area of expertise. `Naad Yogies` dedicated their lives to the "recital" while `Nyaan Yogies` gave up all the comforts for one unique area of exploration. A tight control on daily routine, controlled food and sleep, endless practice, made the `Yogies` what they appeared to the external world - the role models. Thus both `Yogas` had at their core, a lifelong commitment to one set of actions. And hence `Karm Yoga` was an appropriate name for the new unified practice. 

`Sakti Muni` however, widened the scope of `Karm Yoga`. He argued that if controlled actions could lead to great recital or path breaking science, then why can't they be applied to regular streams of mundane works. He believed one can be a `Karm Yogi` irrespective of the work they were pursuing. It didn't matter to him if one was a "reciter" or a "cobbler" as long as they had intense focus on their objective and tenacity to stick to one thing. He professed that it was the life long practice more than anything else that made one excel - be it recital, research or even house keeping. In fact he believed that one should adopt their family work for a child learns a lot from their parents - children should build on the family business. The idea was adopted by many elite families in letter and spirit. So much so that if a child wanted to do something outside the family values, s/he was termed `Varn Sankara` - the destroyer of family values.

While `Sakti Muni's` ideas had vision and he delivered them with conviction, they were NOT to everyone's liking - particularly the power brokers. How can a `Nishaad` (hunter) be same stature as a `Naad Yogi`! - they reasoned. And if someone could attain `Karm Yoga` living with their families, and doing their parental business, than who would join the congregation? 

The idea of unification meant a natural degradation of the current beneficiaries of the system. It had commercial ramifications too - it threatened the existing payback system (of `Dravya Yazna`). They felt `Sakti Muni's` path would lead only to anarchy. On the other side, the "old" who wanted status quo with "the jungle rule" saw `Sakti Muni` as the dangerous bridge to the "new world". Up until now, the path of `Yoga` was for select few - those who could sacrifice the pleasures of their life and take on the hard life of the `Ashramas`, but `Sakti's` ideas could change the balance of power. `Karmyoga` may very well become a household name. They thought of `Sakti` as the emerging face of new revolution that could carry the common man with him. If a civil society as a concept was mass adopted, their muscle power would be severely restrained by the rule of law. 

No one knows for sure, but targeting `Sakti` along with all his well wishers appeared to be an easy way to crush the new revolution! And probably `Sakti Muni`, in a hurry to change the world, forgot to handle the balance of power that his father `Vaśiṣṭha` had so carefully navigated to this date. He didn't know abrupt change might cause ruptures never seen before!

## 4.3
---

It wasn't that `Sakti Muni` coined the word. The idea of `Karmyoga` was definitely older. Later in `Bhagwat Gita`, `Dwaipayana` scribed that `Karma` was the basis of evolution.  He wrote that the supreme knowledge shared this secret first with `Vivswata` (Sun) who told it to `Manu` (the first man) at the dawn of "Age of Humans". In the first verse of Chapter four, `Krsna` - the embodiment of supreme knowledge said to `Arjuna`...

> This imperishable (system of) `Yoga` I declared to Vivaswat: Vivaswat declared it to Manu; and Manu communicated it to Ikshaku. Descending thus from generation, the Royal sages came to know it.

Sun is obviously the manifestation engine of our little corner of the universe. All evolution, including that of planets are on account of Sun. The solids, liquids and even the Air on planet Earth owe their creation to the Sun. It is the gigantic atomic fusion engine [^fusion] of the Sun that manifest into elements such as Carbon and Oxygen. Sun itself is evolutionary gift among trillions of stars placed such (in size and luminosity) that it supports a conscious life on one of it's planet.

`Manu` was the beginning of bipedal humans with fully grown conscious mind as well as well developed hands to indulge in actions as determined appropriate by the mind. This ability, available to only humans in this world, was the effect of immense practice by `Manu` and of course a call to action for a humble reciprocation for the divine gifts of Sun - the very source of life. 

In fact, humans are the only bipedal beings on planet earth for they dedicated two front legs to develop hands (and fingers) to indulge in sophisticated actions. Human hands are called `Karmendriyas` - the work organs for action. It is because of our hands that we could indulge in a vast range of actions (including scribing and typing). All other species are forced into specific actions by their nature.

Even prior to `Manu`, the story of evolution through various incarnations of `Vishnu` is the story of intense practice of a solitary skill. `Sirla Bhaktivinoda` in his 1873 [book](https://en.wikipedia.org/wiki/Dashavatara) `Datta-kaustubha` and again in his 1880 book `Kṛṣṇa-saṁhita` premised `Vishnu` an evolutionary force. `Vishnu`, through his incarnations , takes consciousness to ever higher levels. From `Matsyavtara` (fish) to `Krsna`, `Vishnu's` incarnations kick-start a progression in consciousness through `Karm Yoga`.
...
- The next incarnation of `Vishnu` - `Vamanavtar` - a dwarf was the first with somewhat vertical back. Being able to stand on two feets, not only freed up the hands for sphisticated actions, in `Hathyoga` it is said to have opened the route for higher consciouness. As said earlier, `Naad Yogies` attained the skill of recital by moving the life energy to the upper `Chakras`. 
...
`Adrushyanti` explained the purpose of `Vishnu's` ever evolving incarnations to young `Parāśara` in narratives that attracted his imagination. She explained to him that there was no way for the waterborne and the amphibians to know who they were. The quadrupeds were able to recognize their reflection in the water and on lands. They chased their shadows not knowing why could they never touch their own reflection. In absence of vocal communication, they couldn't even confirm (with their network) that the reflection was actually their own selfie. But the selfies are always just a fleeting reflection. They can at best be a starting point of the eternal quest but by no imagination the true shape, for the true shape is in the reflection of universal mirror. All that we see and feel and touch is nothing but us. Our "reality" is our true selfie.
...
`Maharishi Parāśara` witnessed `Bhakti Yoga` evolving first-hand. The popularity of this tradition had `Maharishi` reassess the integrity of `Naad Yoga`. He was convinced that extreme devotion did open the entry into the power structure and thus material success, but he was not sure it was a legitimate path to eternal peace (as promised). 
...
After years of careful study of motion of heavenly bodies and their co-relation with birth of human intelligence, stars were finally aligned. `Maharishi Parāśara` was ready to take a child as his born son. And he named him long before the physical birth — `Krishna Dvaipayana` — Someone who would go beyond duality just like an island between two never-meeting banks of a river. Someone who could establish a middle spot amongst two never concurring ideologies — for the truth lies somewhere near the center. The literal meaning of `Dvaipayana` is ‘born on an island’.
