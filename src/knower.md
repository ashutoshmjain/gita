...
The collapse of a wave function leads to a manifestation (information). The information, through sheer chance, may unlock knowledge about the nature of the underlying potential. A tiny part of Knowledge is now decrypted—that the wave function is an electron wave, the conditions are a vacuum, and that the probability of electron spinning up or down is fifty-fifty. Once this knowledge is decrypted, a small piece of the entire knowledge is said to be decrypted. It is like solving one piece of a huge jigsaw puzzle at a time. Or adding a block to the decrypted knowledge chain. 
...
> The quantum state of Prakṛti is defined by three **guṇas**: *Sattva*, *Rajas*, and *Tamas*. This might feel as if Sāṃkhya posits a three-dimensional quantum space (as opposed to two dimensional hilbert space of "Coin Flip") , but the framework of the three guṇas CAN represents infinite dimensions. How? Because "Gunas" are descriptors—not the possibilities themselves.
>
