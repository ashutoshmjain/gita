...
> A "wave function" is just a fancy way to account for "all the possibilities" of a system. The quantumness of a system means all the possibilities exist together. An observation breaks this "possibility cloud" into a unique state. It is like Monday morning when you are half asleep imagining it was still Sunday. The weekend quantum dream wouldn't collapse till Alexa announced it was 8 a.m. to kickstart the work week, and then it all suddenly gets real. :-)
...
> The quantum state of Prakṛti is defined by three **guṇas**: *Sattva*, *Rajas*, and *Tamas*. This might feel as if Sāṃkhya posits only a three-dimensional quantum space, but the idea of the three guṇas represents infinite dimensions. How? Because "Gunas" are descriptors—not the possibilities themselves:
>
> *   ***Tamas*** represents a state of zero self-awareness, sometimes described as darkness because it is directionless. This state is recognized through its inherent inertia because multiple dualities acting together leave no wiggle room. Imagine Tamas as a quantum system of multitude of dualities. These dualities, rather than independent possibilities, are superimposed over each other as if each possibility always comes with a mirror image—one side: that it truly is, and the other: the way it appears to Purusha—the truth and the appearance of truth. Tamas bears inertia because of the inherent balance of dualities. If untouched, Tamas may prevail forever.
>
