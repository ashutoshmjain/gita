...
This section is about the rationale - kinda the cost benefit analysis ;  as to why Gita and `Karm Yoga `is a way forward.  We have options of hundreds (if not thousands) of ways to spend our time here in this physical reality. Choosing a specific path is hard. We must carefully analyse the choices we make  before committing to one - particularly in these times when the consequences have exponetial  implications. 
