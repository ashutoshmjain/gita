...
> We all know,  practice makes a man perfect. The question is why ? Why is it that we get better at things with each iteration? We will primarily address this question in this section and also see how `Karm Yoga` gives a new vantage to actions and skills built trough daily reps - the ritual of actions - Yazna. 
