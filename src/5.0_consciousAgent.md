...
Now that we a handle on the two basic orientations - one that focuses on the core of the game and seeks to act `Virakta` and the other that expands the exponential fluff and seeks to survive in it - `Asakta` ; It is a common mistake to perceive them as a straight line with two opposite arrows. Instead try  to visualise them as a single spin. 

![spin](spin.jpg)

With this background , I think we are ready to understand the "Reality" .. Two fundamental things - First we seek the "Hidden" and second "we compete". And thirdly "we organize" to form secondary realities. And we lose track of our orientation.
