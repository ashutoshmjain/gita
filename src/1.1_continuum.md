...
- And second that every thing we observe is a "wave". The light is a wave and so are the electromagnetic radiations. Even the tiny particles, such as electrons act as a wave as shown in the popular double slit experiment. I think there is a general agreement in the scientific community that every thing that we observe in this universe is a wave. In fact two of our most potent sensory capabilities - hearing and vision - respond only to waves and I am not sure of touch.


## Waves to strings

A wave has two primary aspects - time , normally plotted on the x axis and an amplitude plotted perpendicular to the linear time. If we take away the time aspect out of the wave, a wave is nothing but a circle. The idea of removing the linear time from x axis is not uncommon. Such plots are called "circular graphs", sometimes also referred to as unit circle. If we remove the time aspect from our minds , a wave is nothing but the spinning circle. The spin of the circle defines the frequency of the wave and the size of the circle defines it's amplitude. In Trigonometry, the spin functions can be described by Sine and Cosine of the angle at the center of circle wrt to the x axis or the perpendicular to the x axis. 

<insert graphic on Mac>

Now assume we are at the center of the circle and we want to observe the circumference in a clock or anticlockwise fashion. What we shall observe is a wave. This is because we can focus only on one point. Thus our focus moves along the circumference. This focal line is also referred to as "Phaser" in the study of signal processing. < This is the point where the energy (or disturbance) is situated >
...
We have five senses - vision , hearing , smell , touch and taste. The first three are the information receptors through the disturbance passed by the waves. The last two are the verification mechanism. Let us say we see a tree with our eyes. This can very well be a trick - may be a visual projection but if we touch it and conform the shape with our hands , we can be sure it is a tree. In humans,  vision of the primary sense for information reception while hearing and smell are secondary & tertiary respectively. In dogs , hearing is the primary information receptor followed by smell and vision. Thus dogs perceive the world in a very different way versus us humans. 

Our vision is to decode the transverse electromagnetic waves , hearing is for longitudinal compression waves that pass through air , smell is for chemicals diffused in the air. Touch is confirmation of solids and taste is confirmation of liquids. Vision being our primary sense has a unique situation in the sense we see the narrow spectrum right at the center of electromagnetic spectrum. This allows us to see the waves as well as the solids. If our vision was tilted towards radio waves , we would probably  never see a solid while on the upper side of spectrum where we have the gamma rays , the waves are mostly particles. Thus we are in the center of duality of wave-particle nature. 

Since we are born into this sensory experience, we can't perceive anything more basic than our sensory reality. This means that waves must ravel to us to enable us see or hear anything. But our sensory perception is more basic than the sensors. For example we can create a sensory world in our dreams. We can see and hear things with in our dreams. There are few studies that point that some of us even experience "smells" in the dreams. We can even use touch and taste in the dreams. This means that the perception is not dependent on waves traveling to our sensors. Could it be that our perception of waves is our own creation ?  Is it possible that the circle that we perceive or the waves that emanate from the phasor motion with in a circle are our creation. What I means to say is format of our perception is same - when we are dreaming , we have a direct access to the stored file , when we are in reality we receive the signals through our senses . 

## The format of our sensory experience

We know mp3 format. It is a format that can have our computer speakers vibrate so as to produce a sound wave. mp4 format can do the same with electromagnetic waves emanatingn from our computer screen. The question is what is the format for the three dimensional reality we have around us. It could be a dream format that we experience directly or a real format that we perceive when we think we are awake. Is there a difference ? We don't know yet but one thing is sure that our understanding of audio is lot more superior with discovery and application of radio waves. We are much better equipped now to decode our own vision as we understood the electromagnetic phenomenon and are able to recreate a visual experience on our screens. With brain machine interface, we shall by pass our sensors. In a way , indulging in our reality is the only way to understand who we are. Are we a evolution of our senses , are we the brain that processes these sensory inputs of are we yet something more deeper !




The life that we perceive, with our three primary senses - touch , hearing and vision; is pretty similar to a book. The fact that we have a real experience in our dreams, means that it is a three dimensional movie. When we open our eyes in the morning , dreams vanish but what we have is also a set of information playing in a format that we don't yet understand. I mean we yet can't store this experience in a .mp4  video file. May be with advancements in metaverse, we will be able to live these experiences based on our choice. But coming back to our point - the live experience that we have is pretty similar to a two hours spent in a book - or a movie. Just formats are different. 

Now , if we find in the book , what we were looking for, we feel happy , elated. If we don't , we obviously feel sad. Who likes to waste couple of hours of their precious time. Same is true with food. You are looking for a specific taste and smell. If you get that you feel satiated. If not you feel ripped. Same is true from our day - and even dreams - if we get what we are looking for , we feel good. If not we feel down. Even if we got what we were looking for, the very next moment we are looking for something else. 

The question is what are we looking for ?  Gita says that our final quest is to find who we are - our own hidden knowledge. 
