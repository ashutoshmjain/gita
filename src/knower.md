...
Conventional definitions are often fudgy and overlapping.  "Information" is seen as trivial inputs, for example : "It is 27 degrees this afternoon.", or "the S&P crossed 6000!". And "knowledge" as something profound - grounded in scripture or science - for example "speed of light is a constant" or "love thy neighbor". A better, and maybe poetic, distinction is:  "information" is seen as "noise" whereas "knowledge" as "signal". 

Looking at few samples of information, it is hard to ascertain if we are getting closer to the knowledge, or drifting away. Even if we had a large set of readings, it is still hard to discern if the path itself was right! You need data at a universal scale, and  a sophisticated algorithm to parse continuous incoming information streams into a binary right or wrong. There needs to be a mechanism to discriminate wrong in favor of the right. A methood that allows us ignore all the unwarranted information. This ability must work efficiently whenever the path splits into two - every single bianry decision - like twenty "yes or no" questions game. This method, in modern AI parlance, is called Objective Function and in Vedic science it is called - Viveka. The objective function is the basis of survival but to excel in given physical conditions, humans need to work righteously - Karm Yoga. In Hathyoga, Karma are controlled by Sahsrara Chakra - the top Chakra - or Charkra of Brain. In AI world - doing right things in autonomous fashion are controlled by Value Function. In either case, Value function or Sahsrara Chakra - both are driven through knowledge. Actions driven by knowledge, say you act with  "Honesty is the best policy" as your driver - it may not be a good objective function but it helps you gain trust of your counter parties - it helps you excel in the long run.

Collecting noise with five-sensory localized receptors (our senses), and  adjudicating with our predictive faculties (brain ), we do an excellent job to ensure survival (increase the window for data collection). But we always lack certainty because value judgement is inherently a quest in the unknown - in the future.  That makes Probability Theory a universal tool. It is not an attempt to brute force through massive data sets - it is a totally different approach to synthsize data. It is a method for abstracting knowledge from noisy information. Something like taking out butter off the curds. From physics standpoint, it is reducton of entropy.

Thus, we will refine core definitions (Information and knowledge)  to align them with the ideas of probability theory - a subtle change but a profound one!
...
*   **Knowledge** is the awareness of all options and their respective probabilities. For example, the simple idea that a fair coin *may* land on either heads or tails with a ~ 50/50 probability is *knowledge*. In a pefect world, there will always be fifty heads for every  fifty tails - NOT say 499000 Heads and 501000 Tails in a trial of a million. The ocurrance of Heads v/s Tails in successive trials of fairly large (say a million) flips, in our noisy world, follows a bell curve, just like pretty much every thing else - from height of oak trees in a jungle to that of the students in a large school. For example,   there is a unique possibility - however small- that in a million flips of a fair coin, you get only one Heads, or none at all! In Samkhya, this departure from the mean, is called "Vikara" - the aberrations of physical world that lead to the normal distrubtion rather than a crystal clear expression of knowledge. If we remove `Vikara`, the left over is "knowledge". 
