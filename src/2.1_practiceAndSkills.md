...
> We all know,  practice makes us perfect. The question is why ? Why is it that we get better at things with each iteration? We will primarily address this question in this section and also see how `Karm Yoga` gives a new vantage to actions and skills built trough daily reps - the ritual of actions - Yazna. 

In the last section we expanded the hypothesis that [protected] knowledge can be interpreted by observing the actions . Actions that it guides us into. These are the actions that you have consciously perfected such as driving, swimming or any other routine that you do . We also saw that the pre-requisite  is to defocus the outcomes. Which means we need to detach ourselves from the sensory pleasures. This is subtle change - not something that will upside down your life. . The idea is not to hate the senses or the sensory pleasures. Survival is after all important. We will talk about the subttle-ness of this change in the test . The idea is to start spending time with action - may be couple hours daily. Krishna says 
