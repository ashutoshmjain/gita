...
There are three things that don't need any more scientific proofs. They are accepted truths of our experience and well validated by science. In a way these are part of  our collective knowledge. 
...
Let us say, we are to search number 10 from a range say 1 to 50. The only answer we get is a "Yes" or a "No". One of the way is to ask fifty questions. Hey - is it 1 ? Is it 2 ? We shall get to the answer in ten question. What if we were searching for 49 ?  Asking 49 questions seems really dumb. Is there a way to shorten our search. We are not only searching, we want to search as quickly possible. Don't we ? There is a better way. We can get to answer in around five questions. How ? 
