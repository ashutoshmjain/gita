...
Conventional definitions are fudgy and overlapping.  "Information" is seen as trivial inputs, for example : "It is 27 degrees this afternoon.", or "the S&P crossed 6000!". And "knowledge" as something profound - grounded in scripture or science - for example "speed of light is a constant" or "love thy neighbor". A better (and maybe poetic) distinction is:  "information" is "noise" whereas "knowledge" is the "signal". Looking at few samples of information -it is extremely hard to ascertain if we are getting closer to the knowledge or drifting away . Even if we had large set of readings, it is still hard to discern if the path itself was right! You need data at a universal scale, and  a sophisticated apprach to synthesize continuous information streams. There needs to be a way to discriminate against a wrong path to choose the right one. This allows us to ignore all the information associated with the wrong path. This ability must work efficiently whenever the path splits into two - ie every bianry decision. This method, in modern AI parlance, is called Value awareness and in Vedic science it is called - Viveka. The modus operendi of Viveka is Karmyoga, and in AI parlance, it is called "Value Function". A side note here is : AI can't really develop a value function unless it is acting autonomously in the real world. Physical actions have immediate consequences. This immediate feedback loop is what AI needs to be able to develop a Value Function, and that is what leads to decentralization.
