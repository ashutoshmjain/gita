...
In Hindu scriptures , the cycle of "Time" is defined as the four `Yugas` "Eons" - `Sattva, Treta, Dwapra and Kali` . These four phases are part of any cycle - a human life , a business organization , a race , a society or a country. All naturally existing systems follow the same pattern of four Eons with varying duration for each. The thought-flow is not that different when we approach this cycle from scientific vantage. In fact, the ideas of religion and science had never been more aligned when it comes to defining the life cycle of our universe. However, the important thing is not the phases or the durations of each phase.  I say this because the very idea of time takes it's birth in this cycle. The important thing is evolution of Time . In a way Time is inseparable from the cycle, yet , it remains the biggest mystery !

## Time

I don' think you will be surprised if I said we all are living at the edge of the time. And "all" includes everything - big or small. The stars , galaxies and of course the chair that you are sitting on. None of us can jump ahead in time even a tiny bit. Why ? Because edge of "time" is NOT a spatial edge. There is no place to jump to. It simply unfolds on us. Still science is very clear that we can move faster or slower in time because we live in a four dimensional world where time is as much a dimension as any other spatial dimension. Einstein adopted this idea in relativity as "Proper Time" - the flow of time experienced by a body in space-time. My proper time can be different from you and is very sure different from Earth and bigger stars. 

To better understand time, let us use established principles. With these principles, we are now much better placed to understand Time . Thanks to the work of countless thinker and scientists, it seems like "Time" is now with in bounds of our knowledge. As a matter of fact, Time is not spatial ; it is an aspect of "Knowledge-verse" but the manifested world can't be expressed without the notion of "Time". In a way "Time" is rate of change - from knowledge to manifestation and back from manifestation to knowledge. You may wanna call it an "Accounting system" that is basis of our sensory perception because our senses can only observe change. For example the notion of color arises if only there is a multiplicity of colors and there is change of color in the view.
...
In a way, travel back in time is quite possible because all the information of past is always available. It is only matter of being able to identify and visualize the old information. This has been true of `Yogies` that they move freely in past as well as in future. `Yogies` are called `Trikal Darshi` - those who can see past , present and future. And as we progress in technology it shall be accessible to all - at least a view of the past. Virtual worlds where you could explore your past - how your cities , neighborhoods looked like say twenty years back? What happened on the first day of your school? You may even be able to walk along the Dinosaurs.  In a way,  we are already doing that through TV and media. We just need to make the experience more immersive . A complete sensory immersion for vision and audio is already there, all we need to add is sense of touch , smell and taste. I am pretty sure such virtual worlds will be common place with in say fifty years. I  say this because if we can speculate the beginning of universe some 13.8 billion years back  to the order of 10^-34 second (the time of inflationary epoch after the big bang) - that too with technology of last century, why wouldn't you have google maps with a time dimension on them - just like a street view.

So we understood that a peep  back into time is possible. May be we will recreate it from our memories , just like the old books, question is can we move faster in time ? The truth is there are exotic places in this universe that move faster in time than what I and you perceive. Let me show you how ..

### Mass

Let us use another proven idea, we know heavier  objects move slower in the space. A better word is "denser" but we know in nature (imagine stars) more mass leads to more gravity which in turn leads to higher core density. For example Earth moves slower than the Moon. Because moon not only moves around earth , it also moves with Earth around the sun. Same is true about Earth and Sun. Earth not only rotates around Sun , but it also moves with the Sun around the Black hole at the center of Milky way. In essence, we see that objects with higher mass have a lesser spatial motion. This is true from relativistic standpoint too. We know when something with non zero mass tries to gain extensive speed - say comparable to speed of light - the system must increase its energy (or mass ) to slow it down. Its a bit tricky because sensationalism has cropped up into science too. It is lot more fun to say - "your mass increases if you move fast - and it does exponentially when you get closer to speed of light" but the fact is this mass increase is to slow the thing down so that it could never cross the sacrosanct value of "C". The only way to reach speed of light is to lose all your mass. In essence - increase in energy slows down our spatial motion. 

The other way to think about it is that if something has spatial motion, it has higher mass. Question is why ?  Hold this thought and let me throw one more basic principle in the mix here . And this one is from Thermodynamics. We know, to move from a "disorderly state" to a "state of order" - what is normally referred to as decrease in entropy of the system, the energy of the system increases. Thus its mass increases. 

That means bodies with higher mass should have less entropy. This in fact is generally true . In fact Black Holes - the objects with the highest possible density do have very low entropy. Black holes are very orderly objects - quite the opposite from light. And they are probably the most stable too from spatial motion stand point. It is somewhat similar to reducing the spatial motion. Thus we can say reduction of spatial speed is akin to reduction of disorder and hence it leads to increase in mass. Other way to prove this point is "light" must be massless because it is the most random entity in the universe. And that is a scientific fact. Photons are, in fact, massless. Thus we may draw from this idea that - "Information" is random. It is the chaos - disorder. And that is exactly what the definition of "Entropy" is. 





In popular science, you must have seen the pictures where they show massive objects bending a flat surface such that the things on the orbit fall towards them. Sadly , it is just an analogy. A very useful way to represent space-time but we know it is a mere representation that massive things - by design - are better organized - they have less disorder - which simply means they attract the lighter things towards them. In a way, we want to follow things that are ahead of us in Time. For example - Einstein was light years ahead of his time. Even now, after 100 years , we are trying to catch up with him. As we said above , time is an aspect of knowledge-verse. A spatial representation is good if it helps but it must not be taken literally. Space doesn't bend. It does contain more massive , less disorderly things. And those entities are ahead of us in Time because better organised things have more "Knowledge". 

The best way to say this is simply - less disorder has more mass and we know mass attracts. The "bending of space-time metaphor" may work when we are trying to explain the gravity to elementary school but how do you explain why the things compress themselves towards their center ? It is really hard to visualize bending of space-time with in Earth herself. Thus it is best to say "higher degree of order attracts". Higher degree of order is nothing but potential energy. It also means it is a way to pack information in the lowest possible volume. Information packed in the lowest possible volume is an expression of "Knowledge".
...
Now you may ask, why don't these balloons just fly away ? What binds them together ? The answer, however, right there in front of us. Just now we all agreed that nothing can jump ahead in time even a tiny bit. Not even a Photon. And every time we take a tiny step into the  future, we do need to account for the past. That clearly means "Time" is the something that keeps everything from randomly flying apart. No balloon can expand faster than the speed of information.  Einstein - like an ultimate traffic controller of our electro-magnetic universe - put a max limit to the speed of information - and that is the speed of light. Thus we can define "Time" in terms of "information".
 ...
 Science is now unanimous on the idea of "inflationary Epoch" which says that I universe expanded exponentially right after the big bang. According to [wikipedia](https://en.wikipedia.org/wiki/Inflationary_epoch) ....
