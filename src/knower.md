...
The way farming is performed with different tools, the "knowing" is performed with (primarily)  five tools - Eyes to see , Ears for hearing, Toungue to taste, Nose to smell, and skin to touch. The knower uses these tools is to use them to watch the field (the body). One who monitors his body all waking hours - tends to it during the sleep - understands it and responds to its needs - is called a knower - just the way one who farms is called the "farmer". 

> He then says, "Know Me as the Knower in every field."

The distinction is qualified here : the farmer in every field may be different  person or a different entity,  but the "knower" in every field is just one - everywhere in every body. And that knower is me. I comprehend the meaning of body's language through the sensors I have posted at chosen places - just the way Farmer installs sensors in his plouging field to measure say moisture in soil and say air temperature. Our senses are tools of the knower to know the body.

The knower may not be complex - like say a complex robot waking up at Mars.  All the sensors to check its internals and environment is the "knower module" of the robot, we may call it "robrain" for lack of better words - a complex one. But knower can be very simple - lets say a string vibrated - a knower is the one watching the string - a wave function that collapsed. That knower is same as the one in every robrain - it just watches the body (the field) and knows its existence - awareness.

In previous chapter when Arjuna had asked Krishna to show his true form - universal form as many say  - Krishna gave him divine eyes and he told Arjuna - see this entire universe in me. It means the "knower" is the entirety of the Universe. Or shall we say the universe is looking at us - listening to us - knows us through our senses while  we assume we are looking at the universe through the same set of senses. Which means - senses are a portal - the knower looks at us and we look at the knower through them.
