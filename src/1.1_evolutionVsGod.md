...
Now , uncertainty principle gets self evident when we are checking on tiny subatomic particles, but how do we generalize it to our day to day life ? And again , this is not to say, our pseudo reality is in any way inferior to the underlying true nature. In a way, it is a simplified version to save us from the enormous underlying complexities.  Let us take a deeper look .. 
