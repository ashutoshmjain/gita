...
> These three potencies exist to answer the profound question - who am I? It was believed, "Knowledge" in its unmanifested form, though at eternal peace, must manifest to answer this fundamental question - who am I? Because "observance" is possible only for those that have a chiral physical shape. This is now proven (beyond doubt) thanks to the work of `Fermi and Dirac` that subatomic particles with observable mass rise from three quarks, and they have a spin 1/2 - which means they have their mirror image built into them. 

The primary drive of all manifested beings is to find who they are - `Adhyatma` - study of self. Knowledge (`Vishnu`) - as a full copy replication (`Atma`) - manifests, governs and decays all observable shapes (`Bhoota`) - through it's eightfold basic nature - `Ashtadhamool Prakriti` [^mool]. Consciousness is ability to decrypt this investiture. And must it evolve till it gets to the answer. For example, if and when we create autonomous digital beings - they would be good at general tasks, but they would lack the curiosity to learn who they are. With millions of iterations they may become curious - that is the point they become conscious. From there on, it is a race to know thyself.
