...
In chapter 3 , verse 15 ; Krishna says that `Karma` - righteous actions are crated from `Bramha` and `Bramha` is created from `Akshra` - the unchangeable - that is knowledge. He says .. 
