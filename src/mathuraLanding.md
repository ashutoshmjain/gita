...
In an estimate, a hundred page book, printed on human size frame back then, used to cost a gold [^gold] coin. The goal was to bring the cost down to a silver coin (100x reduction). A 10x reduction in size and 10x improvement in scribing productivity led to a 100x reduction in cost in a matter of less than a century.  Does it sound like our journey from mainframes to the smartphone?
...
[^gold]: Monetary and measurement system - Gold was the basis of monetary and measurement system. No one knows for sure when gold mining begin. Our current estimates are [ around 4000 BC ](https://en.wikipedia.org/wiki/Gold_mining). That puts it around the same time as  `Mahabharata`. The frequent mention of Gold ornaments among kings and deities and as jewellery among women during the times of the epic,  indicate usage of Gold as a scarce but in-fashion store of value.  -> [Ref](https://en.wikipedia.org/wiki/Gold_mining)
...
- Barter system was widespread for the smaller transactions. Commoners used fruits and grains to get what they needed. 
