> Bhagvad Gita starts from section 25 of `Bhishma Parva` - the sixth book of `Maha-Bharata`. Here is a complete extract of original translation. I would highly encourage the reader to take a look at the Translator's  [Preface](https://gita.shutri.com/maha00.html), before reading this section. The preface gives a great perspective on the amount of work and the style choices that the original translator made while rendering this impeccable translation.
>
> This is probably closest you can get to the work of `Krishna Dwaipayana` without having the translator's own biases creeping in. This is not to say there is anything wrong with different point of views, for the times and language, do have their own way to change the perspectives. That said and as for biases, this section is followed by my notes/ essays that see Gita from the eyes of a technical writer of our time.
>
> Ashutosh
