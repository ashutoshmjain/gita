...
The information in `Bramh` is held with in the interrelationships of manifested entities. A woman is someone's mother , a sister and a wife and hundreds of more relationships she has with animate beings and inanimate things. In the physical world, our identity is determined by social graph - connections from the place of birth, the institute , where we work  - tiny specs of information held with in each connection ! `Bramh` is sum total of all the identities - entirety of information.
