...
I don' think you will be surprised if I said we all are living at the edge of time. And that "all" includes everything. The stars , galaxies and of course the chair that you are sitting on. Why ? Because none of us can jump ahead in time even by a tiny bit. Nor can we go back in time.

An easier way to imagine this is to think our universe is made of trillions of balloons. Each one again made of trillions of them. And continue for trillions of times. If you see it holistically , it is just one large balloon. If you see at the level of photon , it is still one balloon - the tiniest possible. Now , as a moment passes , some of these balloons inflate, some of them deflate but nothing is standstill. Every moment, every balloon is a new balloon. Just like any other manifestation , we too are new every moment. That is a good news because you can write-off all your debts of yesterday :-) But unfortunately there is an accounting system that ties us to our past (:-

Now you may ask, why don't these balloons just fly away ? What binds them together ? You might say it is the gravity. But gravity only acts on the masses. What about massless things ? We know from science that Photons are massless. If gravity can't hold the smallest unit of our existence together than how can it hold the entire universe ? Quantum mechanics does show us that Gravity doesn't work at the micro sub atomic scales. This dilemma is at the center of our scientific quest for almost a century now - the elusive "theory of everything" that may combine the laws that govern macro stuff with those that govern the micro states. 
...
In a way `Bindu` knows it exists but it can't ask an intelligent question - "Who am I ?" . Because  answer to such a question can only be found in some sort of manifestation. All it has is information of its existence. In essence it can only receive the signal in time but it can't interpret any knowledge out of that signal. 
