...
Vocals, however, have  a limitation — they are not the best storage medium. Reciters always tend to add their own distortion(s) no matter how hard they iterated on their skills. And they may forget if they missed few days of practice. The biggest problem in the olden days, however, was that audio was neither portable nor asynchronous - It needed physical presence in same space and time.  Written word had to be invented to circumvent this limitation. 
...
Armed with this ultimate spiritual science, he figured out how to predict expression of a specific traits in a new born — with high degree of accuracy. Even today, in India, a priest (`Pandit`) would pictorially draw the state of heavenly bodies at the time of child birth, called `Janmpatri` — a cosmic birth-chart. This document, normally kept as a scroll, details the exact positions of seven main `grahas` (the sun, moon and five main planets), and twenty seven stars `Nakshtras` at the time of birth. It also details the effect of the motion of this system on the subject child's future. It is an important consideration (in many Hindu families) to determine the suitable marital match. 
...
This approach seemed like a much better option than to turn all the `Shruties` into `Smrities` [^shruti]. In that his approach slightly differed from that of his grand father. `Vasishtha` thought if everyone learnt to scribe, all spoken scriptures would automatically get converted into text. He believed humans would find better tools in due course. `Parāśara` on the other side took an approach as to why convert entire history. Why not ascertain "ONE" knowledge and scribe only that for that is most relevant piece of information to pass on to the next generations.
