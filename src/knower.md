...
Looking at few samples of information, it is hard to ascertain if we are getting closer to the knowledge, or drifting away. Even if we had a large set of readings, it is still hard to discern if the path itself was right! You need data at a universal scale, and  a sophisticated approach to parse continuous incoming information streams into a binary right or wrong. There needs to be a mechanism to discriminate wrong in favor of the right. A methood that allows us ignore all the unwarranted information. This ability must work efficiently whenever the path splits into two - every single bianry decision - like twenty "yes or no" questions game. This method, in modern AI parlance, is called Value Function and in Vedic science it is called - Viveka. The feed back system of Viveka is actions in the real world and their conseqences. For AI, to become autonomous, it must either act like us in our world, or create a world of its own - like every other species that shares the planet with us. 
