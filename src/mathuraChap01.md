...
The biggest contribution of ten generations of `Vasishthas` was this  framework. Three words `mantra` - `Om Tat Sàt` covered the questions of origin and rise - how this universe came together - how is it perpetuated, and what it means ?  `Om` signified the origin - the source - a superset of all the possibilities distributed like a wave function. `Tat` signified all observable - the creation - the manifested that we see and touch. And `Sàt` meant truth that the creation bears in itself.
