...
Conventional definitions are often fudgy and overlapping.  "Information" is seen as trivial inputs, for example : "It is 27 degrees this afternoon.", or "the S&P crossed 6000!". And "knowledge" as something profound - grounded in scripture or science - for example "speed of light is a constant" or for that matter "love thy neighbor". A better, and maybe poetic, distinction is:  "information" is seen as "noise" whereas "knowledge" as "signal". It is as if we are here to decipher knowledge out of the noise of information.

Looking at few samples of information, it is hard to ascertain if we are getting closer to the knowledge, or drifting away. Even if we had a large set of readings, it is still hard to discern if the path itself was right! You need data at a universal scale, and  a sophisticated algorithm to parse continuous incoming information streams into a binary "right or wrong". There needs to be a mechanism to discriminate wrong in favor of the right. A methood that allows us ignore all the unwarranted information. This ability must work efficiently whenever the path splits into two - every single bianry decision - like twenty "yes or no" questions game but unfolding in the future. This method, in modern AI parlance, is called Objective Function and in Vedic science it is called - Viveka. The objective function is the basis of survival but to excel in given physical conditions, particularly in a group, humans must act righteously - Karm Yoga. In Hathyoga, actions are controlled by Sahsrara Chakra - the top Chakra - or Charkra of Brain. In AI world - doing right things in autonomous fashion are proposed to be controlled by something  called Value Function. In either case, Value function or Sahsrara Chakra - both are driven by pre-existing knowledge. Actions driven by knowledge, say you act with  "Honesty is the best policy" as your driver - may not appear to be  good objective functions in the immediacy, but they helps you gain trust of your counter-parties. And that eventually  helps you excel in the long run. Morality is a way to form the groups. The group must follow certain pre-ordained precepts - just like groups in the abstract algebra - or consensus rules in case of a self replcating blockchain such as bitcoin. A node may be pruned down - information of the txns may be removed - but it can't function in a network unless it abides by the rules of the network. A full copy of knowledge (not information)  pre-exists in every node.
