...
> Knowledge is the menu of potential futures—it is a way of framing "what to look for" or "what to measure." In Sāṃkhya, this is called *Prārabdha* (the destiny that is yet to unfold but we are quite sure of likely scenarios). A rather watered down anology would be the example of a casino and gambler. In that very limited scope of slot machines and games, a casino has the knowledge even though it can't pick individual winner from the losers. A gambler is someone who is working with "information" as he or she change their moves based on the outcomes. This specific design is very useful becuase even though the game is rigged it is not so in favor of a specific player - even the casino owner can't predict individual hand albeit his loss is going back to his own pocket as the profits for the casino.  In essence, he can play with confidence but money aside, there is deep pleasure to be had in getting three aces on a black jack table. The satisfaction of a being a winner is totally randomized.
>
...
>
> In a way knowledge is something built into the potential. It is the basis for weather patterns to emerge, stock markets to function, from traffiic in busy down town to the effortless flock of birds - everything has knowledge prebuilt. The gradual unveiling of knowledge (for an observer) is thus akin to "decrypting" a puzzle through repeated trials and errors.

Knowledge means you understand the system inside out, not outside in like an external observer. While a well "informed" may cite event(s), knowledge is the only path to hypothesize. It can predict things or lay down prophecies. Knower is an insider. It is so deeply entrenched in the system that it is invisible even to ardent observers unless absolute attention. An observer is collecting information (past), a knower is choosing the direction of future.
...
The collapse of a wave function leads to a manifestation (information). The information, through sheer chance, may unlock knowledge about the nature of the underlying potential. Knowledge is now decrypted—that the wave function is an electron, the conditions are a vacuum, and the probability of an up or down spin of an electron is fifty-fifty. Once this knowledge is decrypted, a small piece of the entire knowledge is said to be decrypted. It is like solving one piece of a huge jigsaw puzzle at a time. Or adding a block to the knowledge chain. 
