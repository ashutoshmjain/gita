...
> Everything that we do , has two very basic constituents - the desire and the actions. We normally act based on desires which is fine. All Gita says is change your focus from "desires" to "Actions".  Just like "desires" ; "actions" are endless. Instead of running after multitude of desires and coming up with a new action plan daily, just decide what you like to do and keep doing it till you perfect the routine. Such a daily repeated set of actions is called `Yajna`. Krishna says that he invented `Yajna` and first told it to the Sun - the God of light. He further says that "Sun" is the seed in all the conscious beings. Thus knowledge of our `Yajna` is inbuilt into us. Finding your pre-decided action plan `Karma` and doing it on daily basis - `Yajna`,  without focusing on "desires" is the only thing that we need to do. Rest everything is just a waste of time and source of all the pains and miseries. 
