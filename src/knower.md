...
To understand this idea, let us take for example a physical field - maybe a field to produce potatoes. If I ask you this "Potato Land" is the field and the one who understands how to sow, feritilize, grow, harvest and sell potatoes - who is he? A farmer - you would say - right? Actions (Farming) define the identity or type of a doer - a "Farmer" in this case. Similarly Maxwell defined a field spread all across the universe - he called it an electro-magnetic field. He identified properties of this field mathematically - what we know as Maxwell's equations of electro magnetism. The point is : electro-magnetic field spans across our Farmer's field. Both the field's co-exist. And since Maxwell, physics has postulated as many as seventeen quantum fields - all universal and fundamental. Krishna's field is different from all physical and scientific fields even though it co-exists with all of them. Existence of one is not a denial to other. From the dawn of time, Science and Spirituality always go hand in hand. In ancient India - Samkhya (system of computation)  was the science, and Advaita was seen as faith - even though modern cutting-edge science is pointing us back to Advaita (the non dual) as the fundamental truth.

The way there is a skill called "farming" in our potato field, in the same fashion there is super-skill called "Knowing". Think of it as a farmer of the body. It is not a different person - it is you. The way farming is performed with different tools, the act of "knowing" is performed with (primarily) five tools - Eyes to see , Ears for hearing, Toungue to taste, Nose to smell, and skin to touch.  One who monitors the body all waking hours - tends to it during the sleep - understands it and responds to its needs - is called a knower - just the way one who farms a is called the "farmer".  The knower uses these sophisticated tools to watch the field (the body). You may say - you use these tools to watch the world - afterall every one in faith as well as science told us that senses are there to perceive the world - not our heart or our gut. This is where we need to broaden our vantage .. What exactly is the role of senses ?

> He then says, "Know Me as the Knower in every field."

The distinction is qualified here: the farmer in different fields may be a different person,  but the "knower" in every field is just one - everywhere in every body. And that knower is me - he said - I comprehend the meaning of body's language through the sensors I posted at chosen places - just the way Farmer installs sensors in his plouging field to measure moisture in soil and air temperature. Our senses are tools of the knower to know the body.

Instead of talking about us humans, if we lay this example in for an automomous robot , the thinking becomes rather clear. Say an autonomous complex robot wakes up at Mars after a two years voyage from earth.  All the sensors to check its internals and environment gradually come to life.  Put-together,  they are part of the "knower module" of robot, we may call them "robrain" for lack of better words - a complex one. But knower can be very simple - lets say a string vibrated - a knower is the one watching the string through sheer mathematics - a wave function that collapsed. That knower is same as the one in every robrain - it just watches the body (the field) and knows its existence - awareness. Like every other physical artifact, the tool kit of knower changes from field to field, it evolves and disolves with time, it improves from one generation of species to the next - yet the function stays unchanged - the purpose is immutable. That purpose is a shape beyond physical comprehension. Even the sophisticated tools from knower's own toolkit fail to see the what the purpose looks like - they fail to see the obvious ..why ?
