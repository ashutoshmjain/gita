...
Let us use another proven idea, we know heavier  objects move slower in the space. A better word is "denser" but we know in nature (imagine stars) more mass leads to more gravity which in turn leads to higher core density. For example Earth moves slower than the Moon. Because moon not only moves around earth , it also moves with Earth around the sun. Same is true about Earth and Sun. Earth not only rotates around Sun , but it also moves with the Sun around the Black hole at the center of Milky way. In essence, we see that objects with higher mass have a lesser spatial motion. This is true from relativistic standpoint too. We know when something with non zero mass tries to gain extensive speed - say comparable to speed of light - the system must increase its energy (or mass ) to slow it down. Its a bit tricky because sensationalism has cropped up into science too. It is lot more fun to say - "your mass increases if you move fast - and it does exponentially when you get closer to speed of light" but the fact is this mass increase is to slow the thing down so that it could never cross the sacrosanct value of "C". The only way to reach speed of light is to lose all your mass. In essence - increase in mass slows down our spatial motion. Question is why ?  

The answer is in "Thermodynamics".We know, to move from a "disorderly state" to a "state of order" - what is normally referred to as decrease in entropy of the system, the energy of the system increases. Thus its mass increases. 

That means bodies with higher mass, in their natural state, should have less entropy. It is somewhat similar to reducing the spatial motion. Thus we can say reduction of spatial speed is akin to reduction of disorder and hence it leads to increase in mass. Other way to prove this point is "light" must be massless because it is the most random entity in the universe. And that is a scientific fact. Photons are, in fact, massless. Thus we may draw from this idea that - "Information" is random. It is the chaos - disorder. An extreme opposite are the Black holes. They are absolutely stationary in space unless two of them collide due to galactic collisions because of underlying changes in the space itself. 

Thus we may say, generally , massive thing have more mass because they are internally better organized. What do we mean by "better organization" ? It is simply ability to pack more information in the lesser volume. In other words mass is information density. It is ability of a manifestation to configure itself in a fashion so that it could hold most information. Now there is work going on to extend Einstein's mass-energy equivalence to information. The idea is called mass-energy-information equivalence though I feel far fetched because the mass created by random bits of information is negligible. It should be at the order of mass of a photon. The mass that we are discussing ere is about the "knowledge". What I am suggesting is that the manifestation itself is wrapping the information in a specific order. In other words, it is the knowledge that manifests itself into things. 

In a way "Knowledge" itself is "Energy".
