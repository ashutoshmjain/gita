...
Conventional definitions are fudgy and overlapping.  "Information" is seen as general inputs about our environment say "how is the weather tonight?", or "how well the stock market doing!". And "knowledge" as something  more grounded in science or say math - speed of light is a constant. A better (and poetical) distinction is "information" is the noise whereas "knowledge" is the signal (hidden in the noise). As five-sensory localized receptors of noise (our body), our predictive faculties (mind) does an excellent job to ensure survival but it lacks certainty - that makes Probability a universal tool to understand reality. It is a method of abstracting knowledge from noisy information. For this essay, we will refine these definitions (Information and knowledge)  to align them with the pure probabilistic quantum world.
