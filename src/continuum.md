...
I don' think you will be surprised if I said we all are living at the edge of the time. And "all" includes everything - big or small. The stars , galaxies and of course the chair that you are sitting on. None of us can jump ahead in time even by a tiny bit. Why ? Because edge of "time" is NOT a spatial edge. There is no place to jump to. It simply unfolds on us. Thus, at the very outset - Time is not a sensory concept. It is something we perceive indirectly. 

To better understand time, let us use established principles. With these principles, we are much better placed to understand Time than any of the top scientists of last sensory. Their work has helped us get to this future where we have lot better knowledge of time. I say "Knowledge" because "Knowledge" as we know is something beyond our sensory apparatus. So time is part of knowledge-verse rather than our sensory spatial universe. In essence Knowledge of Einstein , Feynman and countless other has pulled us towards this future. 

The EM fields let the disturbance pass through them at around 3 Million miles per second. We generally call it speed of light because this is how we see the things but the speed limit is applicable to all the EM waves such as Radio Waves or the Gamma radiations. The only difference is the wave length. Shorter wave lengths means more energy or discreteness. All energy in the space is in the shape of Kinetic Energy and since Electro Magnetic fields are two dimensional - this is essentially a two dimensional flat space stacked over each others like a deck of cards. For simplicity just consider one card. We are ignoring the effect of mass for the time being to build the concepts. All the interactions here are between Photons and Electrons. Photons are massless and electrons have negligible mass. Feynman took over this field where Einstein left and developed a whole new branch of Quantum Mechanics called Quantum Electro Dynamics. After, theory of relativity , this is our best theory in terms of its simplicity and mathematical beauty and it is tested and retested thousands of times. With some approximations to ease the mathematical burden, this theory stands the test of time and all the experiments. 

So with this theory, the electro magnetic field is a quantum field of particles called "Photons" and they interact with electrons. They pass on energy (information) to electrons and consume information from them. That is how we see the and sense this colorful world. But wait - we still have a 2 dimensional world - That ain't much fun . There is one more problem. The "Time" is a very flexible concept in this theory. Things can move back and forth in time. There is no sense of past or future. Because in a 2d flat spatial field - photons move at the speed of light spatially. They stand static in time. A photon has no sense of Time. 

lets turn it into three dimensions - with matter waves. 

Now let us use another proven idea , the idea of mass. What exactly is mass ? If we break the Protons and Neutrons further down the elementary particles are called "Quarks". People normally say there are three quarks in protons and same number in Neutron each but no one knows for sure because Quarks are governed by the probability waves - mater waves. In essence the quarks are rotating with in a Neutron or a Proton . The only difference is spin. A proton has two quarks with "Up" Spin while a Neutron has two with Down Spin. Except in case of high energy collisions as in case of particle accelerators, these quarks exist only with in a Proton or a Neutron. In a way Quarks are a vortex of motion with in a very confined physical space. In other words, the motion is confined to a very small boundary and is not allowed to leak outside. This confined motion gives rise to the idea of "matter". Matter has an associated property on positive mass. In Quantum Mechanics, Quarks are further held with a strong fundamental force - very intuitively named "strong force" :-). The bottom line - after crazy math - is matter forms up when waves become extremely short. Much shorter than the Gamma rays and are confined in a very very small space. This nature lends the information held in this small space a sense of manifestation. I know it is lot of words , but the basic idea is very simple - a structural motion - probably rotation - is what creates matter. This matter adds up in the shape of atoms and molecules and finally in to beings like us humans and even stars. In a way Kinetic energy is turned into Potential energy. 

These tiny particles , with distinct potential energy - lose their spatial motion. But since every thing must move at the speed of light, the loss of spatial motion , turns into motion through Time. Photons have no meaning of Time. They are held in a moment while protons and Neutrons - and every thing made with them - have notion of time. In other words Time is the rate of change in the shape , energy and state of these manifested particles. These particles - these bundles of structured motion confined with in them, have a birth and death - they grow the structure and then lose it with time. Their motion along the time is called "Temporal speed". Temporal speed rises because they lose the spatial speed. 

Consider the graphic below for a better representation of the ideas above . For simplicity , this graphic ignores the bending of space due to gravity. 

![](./circleOfC.jpg)


An unintended consequence of this mass formation is these particles bend the space around them. In a way they are tiny balls kept on a rubber sheet. So the curvature of our 2 dimensional space changes and we get a notion of three dimensional space around the manifested objects. However this analogy of rubber sheet with balls of mass bending it down - and heavier objects such as starts kinda making a well of gravity is misleading. It is only a spatial representation. If we turn it upside down, then the massive objects are what pulling us towards the future. In other words Gravity is a force that takes us to the future. From spatial perspective a massive object is a well of gravity but this massive object is ahead of its surroundings in terms of time because it is contributing most of its motion towards the time. 

> In a way - the gravity is nothing but the Potential Energy represented in Time. 
