...
So we get it that all our observations have a start and an end and there is always room to expand - An infinite expanse cradles all our observations. This is kinda important to wrap our arms around the arrow of the time as we perceive. 
...
The question is how our senses take the shortest distance ? Or the least time to consume - In a way distance and time are pretty similar as shown by Einstein that space-time is a four dimensional construct where time is fourth spatial dimension. Or we can say, what is the fastest way to process the information assuming we are searching something. In essence we are asking what is our sensory algorithm ?

Let us say we are looking for a needle in a 'proverbial' haystack. The most logical way is to split the stack into two equal parts and search the first half. If we found the needle, we don't need to search the rest. If we didn't then look for the needle in the second half. Thus looking outside our observation space is a part of our sensory algorithm. This is a very important aspect - if we deploy the splitting technique, we must be open to checking outside our search space. We can confirm this behavior in our normal experience. The definitive thing about our sensory perception is we always want to know about that split second. What happened just before the start ? And what is going to happen after the end.  
...
Science has shown us that the basis of sensory observations are waves. Light is a wave and so is the sound. Electro magnetic field is a sinusoidal wave. If you read about the double slit experiment, we know for sure that even the physical particles such as electrons too act like a wave. Let is spend some time to understand what is a wave.

A wave has two primary aspects - time , normally plotted on the x axis and an amplitude plotted perpendicular to the linear time. If we take away the time aspect out of the wave, a wave is nothing but a circle. In a way,  we can say , our notion of linear unidirectional time turns the circular reality into a wave. As a scientific fact , time can also be represented in degrees of rotation. For example, in last one hour, while you were reading this book, earth rotated 15 degrees on its axis - 360 degree of a circle divided by 24 means 15 degrees. In essence, time itself is circular. No wonder our watches are mostly circular up until Apple came out with a square-ish watch :-)

Thus we can say, the quality of our senses that mandates fastest consumption of information and their nature to seek outside our search space, turns our circular physical reality into a wave with two oscillating half across a straight line. It makes our focus ; and thus everything else in our lives cyclic like a wave. 
