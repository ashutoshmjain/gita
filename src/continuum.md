...
The easiest way to imagine time as an information field is to try visualize a one dimensional line . Now nothing is one dimensional in our experience so it is quite hard to imagine. Science actually shows, we need many more dimensions to explain our three dimensional experience. Thus imagining a single dimension might seem like an awful waste of time . I means why should I waste time to understand time :-) but trust me, if you go along you will have a much better appreciation of your own world and of course time. 

So let us draw a horizontal line say along the x axis and time as the y axis. Time is unidirectional upwards which means future is below the x axis. You can say we have a horizontal one dimensional line and a timeline attached to every single point on that line as shown in T+1 and T-1. The job of the time line is to capture the history of each point of the x line.  Lets say we are looking for a one dimensional particle along the 1 dimensional line x , the timeline associated to that point tells us if the particle was there or not. 

![](./timeInfoGraph.jpeg)

It is important to mention what I mean from a "dimension". A dimension is something where information can't come from outside. Its a water tight vessel of knowledge. Generally, when we talk of a spatial dimension, it intuitively feels as if the dimension has no width of depth. That is because no information comes out of dimension, there is no way for an observer sitting outside as to what is in there. That is the reason there is no way for an external observer to even see a single dimension. But as a "one dimensional being, inside the dimension, a dimension is entire universe. They don't even know the meaning of thickness of depth till they figure out another dimension. And later we shall see, why someone living in a single dimension must seek another dimension. The timeline that we are attaching to our single dimension is of course within that dimension. Let us not see "time" as a separate dimension. Time is in essence the "knowledge" held in this single dimension. In our example, this knowledge is quite simple - is the particle at this point ? - And the knowledge is expressed as a "Yes" or "No". 


So that we don't conflict with planes that connect two dimensions; lets just call our plane as "one dimensional information field". 1DIF - for short. The answer that each point of 1DIF records is "yes" or "No" based on the question. Question can be - Is there something there ? - Answer can be a "yes" or a "no". Or the question can be - is the temperature more than 20 degrees ? - Answer can be "yes" or "no". You got it!  Time stamp only records "yes" or "no". A "zero" or a "One". An "Up" or a "Down". A "plus" or a "minus". Those are all just notations. The question defines what does it mean when time stamp says "yes" verses a "No". In essence, the answer is written in the time line. What you are trying to figure out is a right question. The good news is it is not hard to figure out the question. It takes few steps to decode the signal once you know the context of the first dimension but we need to spin another dimension to ask those questions. Why ? Because in one dimension all you know is "Yes" or "No" , you can't tell what it is ? Is it a particle or a Panda . Why - just think on this. It is important to grasp this idea before we move forward. A single dimension is just knowledge about something. There is no way to tell what is that something. That is the reason we never plot a one dimensional graphs in school. We need at least two dimensions to plot something. For example let us say you are plotting price of a stock for a company. You need to qualify the price as well as the name of the company. If I ask you to plot only the Price - it has no meaning until I tell you it is for Apple. Since the name of the company is kinda fixed , we simply plot price with respect to time. That is a two dimensional time information field. Let us look at them Since the name of the company is kinda fixed , we simply plot price with respect to time. That is a two dimensional time information field. Let us look at them Since the name of the company is kinda fixed , we simply plot price with respect to time. That is a two dimensional time information field. Let us look at them .. 
