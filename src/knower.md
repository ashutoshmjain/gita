...
This is where Quantum Mechanics provides a crucial insight. It is common knowledge that an act of measurement collapses the wave function. "Wave function" is just a fancy way to say "all possibilies" of a quantum system. Quantumness of a system means all the possibilities exist together and an observation breaks this "possibility cloud" into a unique state. In Samkhya, quantum state is represented by prakriti. Here, Prakriti—an equilibrium of potential—manifests one step at a time through the proximity of Purusha, an eternal but random observer. This observer, in both QM and Sāṃkhya, need NOT be "conscious"—it is just an act of measurement.
