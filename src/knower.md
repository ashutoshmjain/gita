...
>
>> It can .. if earth lost its gravity for a split second just when you flipped the coin. In the truest sprit of probability it can. But the pre-existing manifestions - such as gravity of earth - are the pre conditions. They make sure that out of infinite possibilties, only two are permitted - Heads or Tails. All other "Not Heads" or "Not Tails" are constrained by conditioning of our experiment.
