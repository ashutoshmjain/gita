...
Gita's single biggest insight is built into its postulates itself. At a time, say five-ish thousand years ago, when humans didn't have the mathematical tool box or the appliances of science and compute; Krishna introduced the humanity one of the most unintuitive and obscure idea. At a time when humans had no recourse other than settling and submitting to a strange, unknown and external force - say God; Krishna theorized that the God actually lives in all of us in the shape of complete, untempered and unaltered knowledge what he named - `Atma`. Our own copy of the God. Embedded or seeded deep into us. It was a radical idea for the time. This was obviously something beyond imagination of that time. And probably even now !  But now we have advantage of many scientific discoveries that defy our imagination. For example the postulates of quantum mechanics are beyond our day to day reality, yet we accept them for their experimental predictions are beyond debate. No one can agree to Schrodinger's wave equation at the face value unless we delve deep into the probabilistic nature of our universe. For that matter even Einstein's relativistic approach is beyond us unless we see the experimental truth that gravity does warps the space or the space-time not sure which one is a correct choice of the term :-) . Coming back to Gita, the idea that Krishna discovered is experiential. As testable as the postulates of most of the science ; however Gita doesn't have a mathematical bias or limitation. After all we need mathematical proof only to convince experimental physicists to take up expensive experiments. Instead, Gita's postulates are individually testable - I don't need to prove mathematically to myself to test something that I can run through in my daily routine. In essence the idea is so simple and so easily testable that anyone can do it in there own vast laboratory that we call life. 
...
### Worth knowing and Knowable by encrypted.
...
To sum up the hypothesis into scientifically testable postulates .. 
