...
The ‘texting revolution’ was a bigger leap forward (than the current digital internet), simply because the focus was on comprehensibility. And such that the message stayed in the memory once read. Which meant iterative rigor to precipitate the words into immaculate verses. The legend says `Mahabharata` got to it's current state in over six hundred years. It was like the Wikipedia of that time except it was also a poem of highest order. Every king, every invention of value, must find it's place in `Mahabharata`, but in a fashion that it was readable and put to use in a human life-time. The vastness of current (digital) knowledge store, on the other hand, necessitates that a new conscious form must replace humans. Or humans amalgamate with AI tools. Good or bad ? - only time shall tell!
...
What motivations led to this major step-up in our approach to preservation of knowledge? Why would someone take the pains to scribe entire history? How was wisdom drawn off the history and more importantly, how was this wisdom tested for truth before putting into text? 
