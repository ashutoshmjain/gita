...
[^kalki]: A universe is defined by a set of physical rules. The knowledge bends the rules of physical universe. For example sound waves, in our physical universe travel only in a medium (air or water) but with advancement in science, we have converted sound signals into electromagnetic waves that travel at the speed of light - radio and cellular phones. And thus they have no limitation of distance or the medium. We need not self impose the limitations of gravity on our avatars in virtual worlds. In a way we have already created a layer over physical rules of the current universe. 
- Arguments can be made that if a new species lived off our current knowledge base, they would be a far superior species than humans - we may code it to not fight over petty things -  we have an option to create a vastly altruistic world. Even in our universe, automation may lead to such productivity gains that humans may defy the core principles of evolution - survival of the fittest. In many ways we are already doing that. In fact , with set of existing technologies, the next stage of evolution is already on our doorsteps. As per `Vaidik` framework, every tenth incarnation of `Vishnu` , leads the way to the next physical universe. The tenth incarnation is named `Kalki` which literally means automation. 
