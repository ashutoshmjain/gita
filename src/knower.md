...
This essay seeks to understand the characteristics of the "Knower" by bridging modern physics, computing, and ancient Vedic philosophies—Sāṃkhya and Advaita Vedānta.
...
> Knowledge is the menu of potential futures—it is a way of framing "what to look for" or "what to measure." In Sāṃkhya, this is called *Prārabdha* (the destiny that is yet to unfold but is quite clear how it is likely to unfold).
>
...
For an external observer, knowledge unfolds with every new piece of information. For example, if it was your first time flipping a coin, you would soon realize that heads and tails are the only pair of options. For a binary pair such as coin toss, "Not Heads" exists but eventually it means "Tails", and vice versa. And that heads and tails are random occurrences, but there is an order in that randomness. If you flipped enough times, the occurrences of heads and tails converge. The amazing thing is: 

> No one ever told "the coin" how to behave. Knowledge is embedded into the potential of the "coin flipping experiment." The gradual unveiling of knowledge (for an observer) is thus akin to "decrypting" a puzzle.

Knowledge means you understand the system inside out, not outside in like an external observer. While information may cite random event(s), knowledge may hypothesize. It can predict or lay down prophecies. Knowledgeable is an insider; informed , on the other hand, works with observations. 
...
In Sāṃkhya, the quantum state is represented by Prakriti. Prakriti, an equilibrium of potential, manifests one step at a time through the proximity of Purusha, an eternal but random observer. This observer, in both QM or Sāṃkhya, need not be "conscious" (like a human)—it can be an automated act of measurement. Just the way Alexa, though not conscious, measured your Monday morning to let loose reality!

> While the concept of Prakriti is well understood in modern science—all elementary particles (quarks, bosons, electrons, etc.) exhibit quantumness—the idea of an "elementary observer" is conspicuously missing. Why should Purusha seek to observe? What makes it take random measurements?
>
...
But the question remains, why do things manifest when we make an observation? Quantum Field Theory uses the word "decoherence" to describe this phenomenon. The universe that we see is the result of decoherence. Science is pretty good at describing what happens, but "why" is a bit fuzzy. Maybe it is lost in super-complex mathematics. Sāṃkhya provides a rich mechanism for this play (decoherence) through the inter-operations of the three Gunas. 

The best part is: it is easy to comprehend.

> The quantum state of Prakṛti is defined by three **guṇas**: *Sattva*, *Rajas*, and *Tamas*. This might feel as if Sāṃkhya posits a three-dimensional quantum space (as opposed to two dimensional space of "Coin Flip") , but the idea of the three guṇas CAN represents infinite dimensions. How? Because "Gunas" are descriptors—not the possibilities themselves:
>
...
>
> *   ***Rajas*** represents the motivation to discriminate, choosing ONE duality from the chaos of hundreds of dualities of Tamas. It is the state of rigor and doubt; or internal struggle because it is always dealing with dualities. Finally, if it succeeds, **Rajas picks up one duality and offers a choice to the observer**. In our coin-flipping experiment, you may think the option is "Either Heads or Tails"... no... it is one of two resolutions: "Heads or No Heads" vs. "Tails or No Tails." To make this idea simple, think of yourself as an investor in the stock market. You have thousands of choices, but you can't really make an investment if you want to analyze all the scrips—this is a state of Tamas. Rajas is the grind to finally get to a place where you want to place all your eggs in, say, a Bitcoin ETF. When you are presented with this choice, you still have a duality: invest or not?
>
