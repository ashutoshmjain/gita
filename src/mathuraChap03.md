`Abhivaykti` (noun) means expression. While inner knowledge is inexpressible (`Avykta`), external knowldge could be expressed (`Vykta`). Humans and animals, alike, express through muscular postures (`Mudra`)  — primarily facial in humans. Animals express through various bodily postures, for example a dog stretches as a signal that he is ready to run. A tiger pauses before setting the attack routine. Even trees and plants express by shedding their leaves or folding the flowers. Expression is a pre-requisite for networking and the external "knowledge" is held in the network.

In addition to muscular expression, humans developed exceptional sophistication in vocal expression. Every vocal art form, seeks to enhance this sophistication to the next level. In West, vocal expression probably reaches its zenith in "opera", On the Eastern side, it achieves perfection through `Vaidik` recital — a format so distinguished that the most exquisite language `Sanskrit`, finds it's roots in `Vaidik` recital. Vocals, however, have  a limitation — they are not the best store for external knowledge. People always tend to add their own distortion(s) to the recital no matter how hard they may control. And they may forget if they didn't practice for few days. Even today, when we have digital means to store voice, audio poses many challenges when it comes to search as well as training data. 

Written word had to be invented to circumvent this limitation. Humans expression (`Abhivakti`) thus has three primary forms - muscular (`Mudra Yoga`) - dance forms or acting; recital (`Naad Yoga`) - `Vaidik` recital to store knowledge or performing arts such as singing to please an audience; and written word (`Nyaan Yoga`) - primarily as a store of knowledge but a slight variation "fiction or narrative" offers opportunities to engage the readers. 

The muscular form does have some storage value in the sense certain gestures may be used to represent key ideas. For example, in India we use folded hands as a symbol for respect, shaking the neck as a gesture to express "yes", and doing so laterally as a symbol for "no"; but they have limitation when it comes to expressing complex ideas. Effectively only two contenders emerged as potential carrier of knowledge - recital and the written word.
...
Some researchers of knowledge — `Nyaan Yogies`, did consider the idea of converting the `Mantras` into text format — even before `Parāśara`, for obvious advantages of durability and portability.  What if all the `Vyasas` died? What if human race met its demise though epidemic, or other extinction level event. The ancient wisdom must be preserved beyond human shelf life. Those questions existed, but without the comfort of a Mac, “writing” was a herculean task! There were some bold attempts. But they were mostly experimental in nature — half-baked, grammatically obsolete and contextually incoherent. The focus was not on the content. It was on the 'writing apparatus' and to test the claims of “writing” aficionados. The advocacy on the pro-text side was the obvious notion of freedom. And the promise that the divine information could be made accessible to all. Something like the original promise of the internet!
...
How would you send the homage — the `ghee`, fruits and milk to the deities without proper ritual? — they argued ! 
...
> Astrology (`Jyotish`) is the long old ancestor of modern day cosmology. Most people think astrology's secret sauce is somehow foretelling the future through broad predictions that had apply to almost anyone, but astrology was inherently a deep understanding of space and time. Effect of motion of massive celestial bodies in space-time, on our physical reality — our tiny box. Armed with this ultimate spiritual science, they figured how to predict the effect of celestial conditions that might blossom the expression of a specific gene pool in a new born — her traits — with high degree of accuracy. 

 Even today, in India, a priest (`Pandit`) would pictorially draw the state of heavenly bodies at the time of child birth, called `Janmpatri` — a cosmic birth-chart. This document, normally kept as a scroll, details the exact positions of seven main `grahas` (the sun, moon and five main planets), and twenty seven stars `Nakshtras` at the time of birth. It also details the effect of the motion of this system on the subject child's future. It is an important consideration (in many Hindu families) to determine the suitable marital match. 
...
> The struggle for innovation is slightly more nuanced than what appears on the surface. We normally think that the fight is between past that wants status quo verse the future generations who see the obvious advantage of new technology. But the truth is the fight is always with in the proponents of new tech. Whenever new manifests, it always comes with parity symmetry (mirror image)  for duality is the fundamental potency of nature. In this case, while on the surface it appeared that the `Rakshas` (who wanted to retain the jungle rule) were fighting the ones who wanted a civil way of life (through storage of knowledge); but the truth is power struggle was with in the civilized world -  the vocal "maximalists" verses the writing "aficionados". 
>
