...
To understand this idea, let us take for example a physical field - maybe a field to produce potatoes. If I ask you this "Potato Land" is the field and the one who understands how to sow, feritilize, grow, harvest and sell potatoes - who is he? A farmer - you would say - right? 

Actions (Farming) define the identity or type of a doer - a "Farmer" in this case. 

Similarly Maxwell defined a field spread all across the universe - he called it an electro-magnetic field. He identified properties of this field mathematically - what we know as Maxwell's equations of electro magnetism. The point is: electro-magnetic field spans across our Farmer's field. Both the field's co-exist. And since Maxwell, physics has postulated as many as seventeen quantum fields - all universal and all fundamental. Krishna's field is different from all physical and scientific fields even though it co-exists with all of them. Existence of one is not a denial to other. From the dawn of time, Science and Spirituality always go hand in hand. In ancient India - Samkhya (system of computation)  was the science, and Advaita was seen as faith - even though modern cutting-edge science is pointing us back to Advaita (the non dual) as the fundamental truth.

The way there is a skill called "farming" in our potato field, in the same fashion there is super-skill called "Knowing". Think of it as a farmer of the body. The way farming is performed with different tools, the act of "knowing" is performed with (primarily) five tools - Eyes to see , Ears for hearing, Toungue to taste, Nose to smell, and Skin to touch.  One who monitors the body all waking hours - tends to it during the sleep - understands it and responds to its needs - is called a knower. The knower uses these sophisticated tools to watch the field (the body). You may say - you use these very tools to watch the world - afterall every one - in faith as well as in science - told that senses are there to perceive the world - not our heart or our gut. It is a common beleif that senses are to see all the external - this is where we need to broaden our vantage .. What exactly is the role of senses ? The world that I see with my senses is the one tiny box minus "me". This perception of reality is like a cast in which "I" happen to be forged - like a hand and glove. We use our senses to understand the glove - can we fit into our tiny box - is there a wiggle room - can we ever get out of it? Think of senses are as chiesels that shape me - shape you - and shape everyone in their own tiny box - all days of a week. Our brain , our gut and our heart is simply responding to the tiny box we have around us - what you think as the view of the world - for knower it a raw stone - and he is carving you out - you are the statue. When you dont like your reality - he is saying statue is not good - when you are happy with in your tiny box - the statue is cominng along well.

> He then says, "Know Me as the Knower in every field."

The distinction is qualified here: the farmer in different fields may be a different person,  but the "knower" in every field is just one - everywhere in every body. And that knower is me - he said - I comprehend the meaning of body's language through the sensors I posted at chosen places - just the way Farmer installs sensors in his potato field - to measure moisture in soil - and air temperature. Our senses are tools of the knower to plough our tiny reality.

Instead of talking about us humans, if we lay this example in for an automomous robot , the idea becomes rather clear. Say an autonomous complex robot wakes up at Mars after a two years voyage from earth.  All the sensors to check its internals and environment gradually come to life.  Put-together,  they are part of the "knower module" of robot, we may call them "robrain" for lack of better words. Robot obviouly has a function otherwise why would any one send it to the north pole of Mars of all the places. It does what it needs to be but a team at SpaceX gets involved if it can't see or hear - some of its sensors go bad - it stops syncing the data - or it stops working. May be it needs some tweaks to adjust to the harsh weather of its new reality - may some help .. 

This implies as if knower is a super sohisticated engineer - no - knower can be very simple - lets say a string vibrated - a knower is the one watching the string through sheer mathematics - a wave function that collapsed. That knower is same as the one in every robrain - it just watches the body (the field) and knows its existence - awareness. Like every other physical artifact, the tool kit of knower changes from field to field, it evolves and disolves with time, it improves from one generation of species to the next - yet the function stays unchanged - the purpose is immutable. That purpose is a shape beyond physical comprehension. Even the sophisticated tools from knower's own toolkit fail to see the what the purpose looks like - they fail to see the obvious ..why ?

In previous chapter when Arjuna had asked Krishna to show his true form - universal form as many say  - Krishna gave him divine eyes and he told Arjuna - see this entire universe (sa-chara-achar: means entire universe with all moving and non moving things) in me. It simply means the "knower" is the entirety of the Universe. It makes sense from definition standpoint as well - how can knower be just same ONE in every body unless every separate body is suspended in it - like droplets in an ocean. Shall we say the universe is looking at us - listening to us - knows us through our senses while we assume we are looking at the universe through the same set of senses. Which means - senses are a portal - the knower looks at us and we look at the knower through them.

The field is the body - senses are the portal - knower sees the body - and the body sees the world. While the knower can see the entire field, body gets to see only the parts relevant to it. Why should body A have access to the experiences and questions of body B ?  Root access is granted only when needed - the divine eyes. 

This essay seeks to understand the characteristics of the "Knower"  - one who holds the root access - exploring  modern physics and computing alongside ancient Vedic philosophies of Sāṃkhya and Advaita Vedānta that asks a simple question - are body and universe two separate entities?  How do we understand the difference ? In Samkhya and Advaita both - the path is however just One :  
...
Conventional definitions are often fudgy and overlapping.  "Information" is seen as trivial inputs, for example : "It is 27 degrees this afternoon.", or "the S&P crossed 6000!". And "knowledge" as something profound - grounded in scripture or science - for example "speed of light is a constant" or for that matter "love thy neighbor". A better, and maybe poetic, distinction is:  "information" is seen as "noise" whereas "knowledge" as "signal". It is as if we are here to decipher knowledge out of the noise of information - but why? Why is knowledge cherished over information!

Looking at few samples of information, it is hard to ascertain if we are getting closer to the knowledge, or drifting away. Even if we had a large set of observations, it is still hard to discern if the path itself was right! You need data at a universal scale, and  a sophisticated algorithm to parse continuous incoming information streams - into a binary "right or wrong". There needs to be a mechanism to discriminate wrong in favor of the right. A methood that allows us ignore all the unwarranted information. This ability must work efficiently whenever the path splits into two - every single bianry decision - like twenty "yes or no" questions game but unfolding in the future. The question here is not where I was a decade back - the question is where will I be a decade later. Larger the window of time - harder the prediction! Only knowledge can provide such an answer - is that why it is cherished? 

This method (of discrimination), in modern AI parlance, is called Objective Function and in Vedic science it is called - Viveka. The objective function is the basis of survival but to excel in set of given physical conditions, particularly in a group, members must act righteously - act exactly as per the assigned role - Karm Yoga. In Hathyoga, such actions are said to be controlled by Sahsrara Chakra - the top Chakra - or Charkra of Brain. In AI world - doing right things, in autonomous fashion, are proposed to be controlled by something  called Value Function (we are still building Value Function). In either case, seat of "Value function" or Sahsrara Chakra - both are driven by pre-existing knowledge. Actions driven by knowledge, say you act with  "Honesty is the best policy" as your driver - it may not appear to be  a good objective functions in the immediacy, but it helps you gain trust of your counter-parties. And that eventually  helps you excel in the long run. Morality is a way to form the groups. The group must follow certain pre-ordained precepts - just like groups in the abstract algebra - or consensus rules in case of a self replcating blockchain such as bitcoin. A node may be pruned down - information of the txns may be removed - but it can function in a network if it abides by the rules of the network. A full copy of knowledge (not information)  pre-exists in every node.

Collecting noise with five-sensory localized receptors (our senses), and  adjudicating with our predictive faculties (brain ), we do an excellent job to ensure survival (increase the window for data collection). But we always lack certainty because value judgement is inherently a quest in the unknown - in the future.  The question, for both natural as well artificial intelligence, always is - how to premept the right over the wrong? That makes Probability Theory a universal tool. It is not an attempt to brute force through massive data sets - it is a totally different approach to synthsize data. It is a method for abstracting knowledge from noisy information. Something like taking out butter off the curds. From physics standpoint, it is reducton of entropy, and from philosphical standpoint it is unveiling the truth from under the veil of illusion. Advaita says - truth (knowledge) pre exists but it is veiled by illusion of Maya (information).
...
*   **Knowledge** is the awareness of all options and their respective probabilities. For example, the simple idea that a fair coin *may* land on either heads or tails with a ~ 50/50 probability is *knowledge*. In a pefect world, there will always be fifty heads for every  fifty tails - NOT say 499000 Heads and 501000 Tails in a trial of a million. The count of Heads v/s Tails in successive trials, in our noisy world, follows a bell curve, just like pretty much every thing else - from height of oak trees in a jungle to that of the students in a large school. For example, there is a unique possibility - however small- that in a million flips of a fair coin, you get only one Heads, or none at all! In Samkhya, this departure from the mean, is called "Vikara" - the aberrations of physical world that lead to the normal distrubtion rather than a crystal clear expression of knowledge. If we remove `Vikara`, the left over is "knowledge". 

With this new definition set, lets ask the question again: why knowledge is better than information? - why signal is better than noise? Right off the bat, knowledge represents tremendous compression over information. For example - the storage space required to hold the record of one million events is a million time larger than storing the idea that Heads and Tails are equally likely. The important thing is "knowledge" is not lossy - it carries the same level of fidelity. Quite the opposite, information is always lossy. Looking merely at the quantitative aspect - the simple probablistic definition that heads and tails are equallly likely - is not limited to say only a million flips - it represents a trillion trials of a say a trillion flips each, with same cognitive accuracy. Such knowledge is represented as `Atman` in both Sanmkhya and Advaita. The key insight of this understanding is that the knowledge is most compressed form of a signal that can replicate itself infinite times - over and over again. Which means knowledge is a force of decentralization. On the other side, collecting information is always a pursuit of centrlization - it what we call intelligence (collection and processing of in-formation is in-telligence) .

> One who fully understands this most compressed signal is called knower. Since everyone and everything is a replication of this primordial signal, it means a full copy of knowledge exists in every single being - everyone can realize the knowledge with in and become a knower. But it is almost impossible to pin point the knowledge ! Why ? Because knowledge is not a secret held - it is the flip side of all secrets. 

Lets try to pin point what knowledge is:

Knowledge is the menu of potential options. For example: these are the "only" items available for dinner tonight-nothing else. It is a way to let observers frame "what to look for" or "what to measure"-a set of permissions or degrees of freedom. In Sāṃkhya, this is called *Prārabdha* (the destiny that is yet to unfold but we are quite sure of the likely scenarios). A binary system is a perfect example - it can be zero or one - on or off. There is no third choice. Complete information is presented even without a flip. For example with the knowledge of the rule, I can say with confidence that the other side is Tails as soon as I look at Heads side of a coin in my hand. I know for sure that if I flipped this coin, it will be either Heads or Tails. This explicit understanding of a situation is the hallmark of intelligence but the knowledge is heads and tails are sides of the same coin - so is love and hate and rise or fall - the binary vantage is just hiding half the story. But this is an over-simplification ..

A common analogy is the mechanics of a casino. In that very limited scope of slot machines and games, a casino manager has the knowledge as to how much edge she has (per hand), though she can't pick up gains against a specific player. She has control over final outcome but not on individual session. A gambler, on the other hand, is someone who is changing his bets based on the "information" of the individual outcomes - fully aware that probability is stacked against him. This design is useful because even though the game is rigged it is not so in favor of a specific player. Even the casino manager couldn't predict individual hand if she wished to try her own luck. Sāṃkhya thus, despite being atheistic, accepts divine incarnation, albeit such incarnation is as tied to the physical laws as an ordinary player to the rule book of casino - there are no special privileges. Except for the awareness of preexisting knowledge - what exactly is that knowledge ?

> A singularity is state of no change - because the system affords only one possibility - there are no options. This is what is known as "Advaita" - non dual.

A binary system is a predictive certainty ? because if it is not Tail, then you know for sure it is a Head. The binary outcomes are perfectly entangled - there is no information beyond us in the dark. Logical deduction quickly tends towards impossible as the number of possibilities increase. You have experienced it when you choose a cellular plan , or a smart phone - there are so many options - each a possibility for a different path. Human brain breaks down at three choices. We can do "what if" scenarios with computers but we are not well equipped to appreciate their true meaning - because we are trained to seek accuracy!
...
If the outcomes are NOT following an established plan - then that means there is a change in the physical reality. Knowledge can't predict the next outcome but it never misses a change in setup. A change in conditions immediately changes the odds - without fail. There is no way to bluff the knowledge:  if you flip a coin in air, it can't just fly to outer space! Or can it? 
