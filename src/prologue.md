...
>
> The next step up in this ability was the "written word". With written word storage capacity got tremendous boost. It is impossible to determine the exact number of books that have been written to date, as new books are being written and published every day, and many books from the past have been lost or destroyed over time. However, it is estimated that there are over 130 million books in existence as of 2021. Library of Alexandria, built by Ptolemy in early days of the written word ( around 3rd century bc) had anywhere between seventy thousand to seven hundred thousand papyrus rolls. A conversion into a modern textbook size should end up hundred to two hundred thousand books.
>
...
‘Text’ was the new medium. It was somewhat similar to our migration from analog to digital. Not only did it demand new writing skills, it also meant the populations must learn reading, beyond a select class of sages and super sages. We needed mass adoption of computers in early nineties to kick start the digital shift. Superior intelligence `Ganesa` was invoked to usher the humanity into this new era, just the way we are using natural language processing in current digital realm. 

The ‘texting revolution’ was a bigger leap forward (than the digital internet), simply because we are talking thousands of years in the past. The legend says `Mahabharata` got to current state in over six hundred years. It was like the Wikipedia of that time. Every king, every invention of value, must find it's place in `Mahabharata`. 
...
In an estimate, a hundred page book, printed on human size frame back then, used to cost a gold [^gold] coin. The goal was to bring the cost down to a silver coin. And bring the size down to a tenth of the human size. An order of magnitude reduction in size, paved the way for large scale adoption of written words. Does it sound like our journey from mainframes to to the smartphone?
