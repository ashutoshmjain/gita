...
You may further question that even a circle has some element of time on the x axis - equal to its diameter . And you are absolutely right . If we remove even the diameter; what we are left with is a simple harmonic oscillation perpendicular to the x axis. Just like a pendulum or a vibrating string. 

Thus we can say, our "senses" that are busy in eternal quest, turn our circular or the string of underlying physical reality into a wave. A wave  with two oscillating half across a straight line. They split our focus ; and thus everything else in our lives cyclic - like a wave. This argument might inspire you to dig into the mathematics of "String Theory" - like it did to me :-) . Here are my two cents - you may , but trust me, the math is insanely complex. At least beyond my comprehension. I would rather have you test this through a very simple example that you can conduct right here - just look closely at a violin ; or a guitar and pluck a string . Your eyes see a wave. Your ears hear a sound that is nothing but a wave but in reality , different parts of the string are just oscillating at the same place - Just the simple vibration lead to our sensory perceptions.
