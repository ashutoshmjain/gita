...
>
> This three dimensional reference model - sound , text and reality (visual confirmation) -  is at the core of training the large language models that we carry in our brains - consciousness. It is order of magnitude potent than the speech only world that was limited to synchronous dialog - basis of barter. It is important to note here that human language is audio first whereas artificial intelligence is text first.
