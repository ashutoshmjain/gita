...
*   **Knowledge** is the awareness of all possibilities and their respective probabilities *before* an event happens. The understanding that a coin *can* land on either heads or tails with a 50/50 probability is *knowledge*. The probability of an electron spinning up or down in a perfect vacuum is exactly like a coin toss—fifty-fifty. If the electron cloud somehow retains this "ability of prediction," then we deem the cloud knowledgeable. If some external observer develops this capability, then that external observer is the "knower." In essence, knowledge is the menu of potential futures—it is a way of framing "what to look for" or "what to measure." In Sāṃkhya, this is called *Prārabdha* (the destiny that is yet to unfold but is quite certain how it shall unfold—the likely scenarios).
...
> Even if it may conflict with formal epistemology, for the sake of this essay, "Knowledge" is the set of rules governing the probabilities and prerequsite conditionality of potential, while information is the record of manifested reality.

For an external observer, the Knowledge unfolds with every new trial. For example, if it was your first time flipping coins, you would soon understand that Heads and Tails are the two options and they happen randomly but there is a magic in that randomness - if you flipped enough times, the occurance of Heads and Tails are more or less same. But this knowledge is inherrent in the "coin flipping experiment". No one ever told the coin how to behave. The unfolding of knowledge (for an observer) is thus akin to "decrypting"—as if the entirety of knowledge was hidden behind a veil. There is no way to understand how a (complex) system would behave other than observing it diligently. The pattern always emerges amidst the apparent chaos. There are rules at play that ordinary conscious observer such as us humans are unaware of.
...
> While the concept of Prakriti is well understood in science in terms of all the possibilities—a quantum system—the idea of an elementary observer particle is rather mysterious. This is unique contribution of Samkhya! Why should Purusa seek to observe? What makes it take random measurements?
>
...
Lets park the question of observer's motivation for now. The answer will emerge as we delve deeper into reality. For now, whatever be the reason, the collapse of a wave function leads to a manifestation (i.e., information). The "knowledge" is retained in the rest of of the possibilities. For example - we know for sure that the wave function belonged to an electron if the manifest was an electron. We know, the trial must be "the tossing of a coin" if the manifest is "Heads (or Tails)." Infinitely many trials harden the knowledge into exact probabilities. In essence, knowledge is now decrypted—that the wave function is an electron, the conditions are a vacuum, and the probability of an up or down spin of  electron is fifty-fifty. Once this knowledge is decrypted, a small piece of the entire knowledge is said to be decrypted. It is like solving one piece of a huge jigsaw puzzle.

Sāṃkhya provides a rich mechanism for this play through the inter-operations of the three Gunas:
