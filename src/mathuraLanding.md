...
`Mathura` - the city, was the geographic center of `Bharata` — the ancient India. The ancient Indian civilization was spread over most of [ South Asian ](https://en.wikipedia.org/wiki/South_Asia) region - sometimes called "greater India". `Mathura` was the origin of oldest spoken scriptures - the `Vedas`.  Post Neolithic [^neo] revolution, humanity saw the  mass-adoption of written word. `Mahabharta` was one of the first fully scribed epics that captured the interest of masses. It was scribed here -  in a series of eighteen `Parvas` (books). 
